		...
		if( $this->minical_showlink ){
			...
			if( $this->minical_showlink == 1 ){
				...
				if( $this->minical_prevmonth ){
					$content .= $this->monthYearNavigation($basefirst_of_month,"-1 month",'&lsaquo;&nbsp;',JText::_('JEV_CLICK_TOSWITCH_PM'));
				}
				...
				if( $this->minical_nextmonth ){
					$content .= $this->monthYearNavigation($basefirst_of_month,"+1 month",'&nbsp;&rsaquo;',JText::_('JEV_CLICK_TOSWITCH_NM'));
				}
