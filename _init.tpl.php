...
<head>
	...
	<script type="text/javascript" src="<?php echo 'templates/base/core/js/browser/css_browser_selector.js'; ?>"></script>

	<?php
	// LOAD JAVASCRIPT BASE
	...
	$doc->addScript('templates/base/core/js/base.js');
	?>
