...
function pagination_list_footer($list)
{
	...
	$html .= "\n<spannput type=\"hidden\" name=\"" . $list['prefix'] . "limitstart\" value=\"" . $list['limitstart'] . "\" />";
	$html .= "\n</div>";
...
function pagination_item_active(&$item)
{
	...
	return "<li class=\"page-item ".$hidden."\"><a class=\"page-link\" title=\"" . $item->text . "\" href=\"" . $item->link . "\" class=\"pagenav\">" . $display . "</a></li>";
}
