...
class XmapHtmlDisplayer extends XmapDisplayer {
    ...
    function setJView($view)
    {
        ...
        if( $columns > 1 ) { // calculate column widths
          ...
          // CUSTOM
          // Set Grid 'col'
          $c = $this->sitemap->params->get('columns');
          $c = ($c <= 12 && $c != 5 && ($c < 7 || $c > 11)) ? (12 / $c) : 4;
          $this->_width = 'col-lg-'.$c;
        } else {
          $this->_width = 'col-12';
        }
    }
    ...
    */
    ...
    function startMenu(&$menu) {
      echo '<div class="'.$this->_width.'">';
      if( $this->sitemap->params->get('show_menutitle') )         // show menu titles
          echo '<h5 class="menutitle base-icon-menu"> '.$menu->name.'</h5>';
    }
