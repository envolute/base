...
<div class="search">
  ...
  <div class="font-featured text-right bottom-space-sm text-embed">
    <h2 class=" text-live no-margin">Buscar no Site</h2>
    <div class="">Pesquise o conteúdo completo do nosso site</div>
  </div>
  ...
  <form class="form-search" action="<?php echo JRoute::_('index.php');?>" method="post" class="form-inline">
  	...
  	$input = '<input type="text" name="searchword" id="mod-search-searchword" maxlength="50" class="form-control input-lg width-full'.$class.'"'.$place.' />';
