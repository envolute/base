<!DOCTYPE html>
<html class="isMM media-md" xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-BR" lang="pt-BR">
<head>
  ...
  <link rel="stylesheet" href="_dev/custom.css" type="text/css" />
	<!-- load guide's default css -->
			...
			<div class="container bs-container">
				<div class="row">
					<div class="row-wrapper">
						<div class="row">
							<div class="col-xs-12">
								<button name="name" type="button" id="toggleMenu" class="toggle_menu visible-xs visible-sm">
									<span class="base-icon-menu"></span>
								</button>
								<a id="brand" class="brand" href="index.php"><img class="img-responsive" src="images/logo-site.png" /></a>
								...
								<a id="brand-client" class="pull-right hidden-xs" href="index.php"><img class="img-responsive" src="images/logo-client.png" /></a>
								<div id="navigation" class="hidden-xs hidden-sm">
									<ul class="nav nav-pills menu">
										<!--li><a href="login.html"><span class="base-icon-home"></span></a></li-->
										<li id="guide"><a href="index.html">Guia</a></li>
										<li id="login"><a href="login.html">Login</a></li>
										<li id="icons"><a href="core/libs/baseicons/demo.html" target="_blank">Ícones</a></li>
										<li id="lists"><a href="report.html">Listagem</a></li>
										<li id="forms"><a href="form.html">Formulário</a></li>
										<li class="parent">
											<a href="#">Sub Level</a>
							...
							<div class="row">
								...
								<div id="main-content" class="col-xs-12">
									<div id="content-toolbar" class="clearfix">
										...
										<div id="toolbar-btns">
											<button type="submit" name="name" class="btn btn-success" onclick="setAlert('success')"><span class="base-icon-ok-circled2"></span> Salvar</button>
									...
									<div id="content-body" class="fullScreen">
															...
															<div role="tabpanel" class="tab-pane active" id="masks">
																<div class="row">
																	<div class="col-lg-6">
																		...
																		<p><input type="text" name="name" class="form-control field-date" data-autotab="false" /></p>

																		<label>Date & Time<br /><code>&lt;input class="field-date" data-time="true" /&gt;</code></label><br />
																		<p><input type="text" name="name" class="form-control field-date" data-time="true" /></p>
...
&lt;/div&gt;
	...
	<script type="text/javascript" src="_dev/custom.js"></script>

	<!-- load guide's default javascript -->
	...
	jQuery(function() {
		...
		jQuery('#navigation #guide').addClass('active');
