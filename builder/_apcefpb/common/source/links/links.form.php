			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group field-required">
						...
						<span class="btn-group btn-group-justified" data-toggle="buttons">
							<label class="btn btn-default btn-active-success" onclick="<?php echo $APPTAG?>_setPaymentInfo(0)">
							...
							<label class="btn btn-default btn-active-success" onclick="<?php echo $APPTAG?>_setPaymentInfo(1)">
				...
				<div id="<?php echo $APPTAG?>-paid-btnGroup" class="col-sm-4 hide">
					...
					<span class="btn-group width-full" data-toggle="buttons">
						<label class="btn btn-block btn-warning btn-active-success" onclick="toggleFieldsetEmbed(this, '#<?php echo $APPTAG?>-paid-fieldsGroup', 0)">
