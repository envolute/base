			...
			<div class="row">
				<div class="col-sm-8">
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="form-group">
								<label><?php echo JText::_('FIELD_LABEL_BLOOD_TYPE'); ?></label>
								<select name="blood_type" id="<?php echo $APPTAG?>-blood_type" class="form-control auto-tab" data-target="<?php echo $APPTAG?>-email">
						...
						<div id="group-email_optional" class="col-sm-6 col-sm-offset-6 hide">
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group field-required">
								<label><?php echo JText::_('FIELD_LABEL_MOTHER_NAME'); ?></label>
								<input type="text" name="mother_name" id="<?php echo $APPTAG?>-mother_name" class="form-control upper" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group field-required">
								<label><?php echo JText::_('FIELD_LABEL_FATHER_NAME'); ?></label>
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group field-required">
								<label><?php echo JText::_('FIELD_LABEL_HAS_DISEASE'); ?></label>
								<span class="btn-group btn-group-justified" data-toggle="buttons">
									<label class="btn btn-default btn-active-success">
						...
						<div class="col-sm-4">
							<div class="form-group field-required">
								<label><?php echo JText::_('FIELD_LABEL_HAS_ALLERGY'); ?></label>
								<span class="btn-group btn-group-justified" data-toggle="buttons">
									<label class="btn btn-default btn-active-success">
										<span class="base-icon-cancel"></span>
				...
				<div class="col-sm-4">
					<div id="<?php echo $APPTAG?>-group-relation" class="hide">
						<span class="btn-group btn-group-justified">
							<a href="#" class="base-icon-location btn btn-success hasTooltip" onclick="addresses_setRelation('.$item->id.')" data-toggle="modal" data-target="#modal-addresses" data-backdrop="static" data-keyboard="false" title="<?php echo JText::_('MSG_INSERT_ADDRESS')?>"></a>
							<a href="#" class="base-icon-phone-squared btn btn-success hasTooltip" onclick="phones_setRelation('.$item->id.')" data-toggle="modal" data-target="#modal-phones" data-backdrop="static" data-keyboard="false" title="<?php echo JText::_('MSG_INSERT_PHONE')?>"></a>
							<a href="#" class="base-icon-bank btn btn-success hasTooltip" onclick="banksAccounts_setRelation('.$item->id.')" data-toggle="modal" data-target="#modal-banksAccounts" data-backdrop="static" data-keyboard="false" title="<?php echo JText::_('MSG_INSERT_BANK_ACCOUNT')?>"></a>
						</span>
					</div>
					<hr class="hr-label" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="alert alert-info small">
								<?php echo JText::_('MSG_PRINT_CARD'); ?>
							</div>
						</div>
						<div class="col-sm-7">
							<div class="form-group">
					...
					<div id="registrationFormGroup">
						<span class="btn-group btn-justified width-full" data-toggle="buttons">
							<label id="<?php echo $APPTAG?>-user-create" class="btn btn-warning btn-active-success width-half hasTooltip" title="<?php echo JText::_('FIELD_LABEL_REGISTRATION_DESC'); ?>" onclick="toggleFieldsetEmbed(this, '#registrationFieldsGroup')">
							...
							<label id="<?php echo $APPTAG?>-user-assign" class="btn btn-primary btn-active-success width-half hasTooltip" title="<?php echo JText::_('FIELD_LABEL_ASSIGN_USER'); ?>" onclick="toggleFieldsetEmbed(this, '#assignUserGroup')">
								<span class="base-icon-user"></span>
								<input type="checkbox" name="userRegistration" id="<?php echo $APPTAG?>-userRegistration" value="1" />
								<?php echo JText::_('FIELD_LABEL_ASSIGN'); ?>
							</label>
						</span>
