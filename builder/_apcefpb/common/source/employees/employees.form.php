			...
			<div class="row">
				<div class="col-sm-8">
					<div class="row">
						...
						<span id="<?php echo $APPTAG?>-group-partner" class="hide">
							<div class="col-sm-8">
								<fieldset class="fieldset-embed top-expand-sm">
									<legend class="pull-right"><?php echo JText::_('FIELD_LABEL_PARTNER'); ?></legend>
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label><?php echo JText::_('FIELD_LABEL_DRIVER_CARD'); ?></label>
				...
				<div class="col-sm-4">
					...
					<div class="well well-sm">
						<hr class="hr-label top-space-sm" />
						<span class="label label-warning">Crachá do Funcionário</span>
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
						...
						<div id="registrationFormGroup">
							<span class="btn-group btn-justified width-full" data-toggle="buttons">
								<label id="<?php echo $APPTAG?>-user-create" class="btn btn-warning btn-active-success width-half hasTooltip" title="<?php echo JText::_('FIELD_LABEL_REGISTRATION_DESC'); ?>" onclick="toggleFieldsetEmbed(this, '#registrationFieldsGroup', 0, '#<?php echo $APPTAG?>-username')">
							...
							<fieldset id="registrationFieldsGroup" class="fieldset-embed closed top-expand-sm no-margin" data-group="fe-registration">
								<div class="form-group">
