		...
		foreach($res as $item) {
			...
			$html .= '
				<li class="'.$rowState.'">
					...
					'.$note.baseHelper::nameFormat($item->place).'
					<div class="small text-muted font-featured">Por '.$client.$item->name.' em '.baseHelper::dateFormat($item->date).' no período de '.$period.$operator.$info.'
				</li>
			';
		}
		$html .= '</ul>';
