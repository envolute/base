        ...
        // COUNT LIST IDS
          ...
          $itemBlock  = ($isUser) ? $userInfoBlock : 0;
            ...
            if($request['userRegistration'] == 1 && $request['user_id'] == 0 && !$isUser) :
              ...
              $eBody = JText::sprintf('MSG_ACTIVATION_EMAIL_BODY', baseHelper::nameFormat($request['name']), $domain, $request['username'], $bodyData, $request['email'], $request['emailInfo'], $sitename);
          ...
          $uList = $db->loadObjectList();
            ...
            if(!empty($_SESSION[$RTAG.'RelTable']) && !empty($_SESSION[$RTAG.'AppNameId'])) :
              ...
              $query = 'DELETE FROM '. $db->quoteName('#__apcefpb_rel_providers_contacts') .' WHERE '. $db->quoteName('contact_id') .' IN ('.$ids.')';
              $db->setQuery($query);
    					$db->execute();
              ...
              foreach ($rIDs as $rID) {
                ...
                $query = '
                SELECT T2.id FROM
                  '. $db->quoteName('#__apcefpb_rel_contacts_addresses') .' T1
                ...
                $query = 'DELETE FROM '. $db->quoteName('#__apcefpb_rel_contacts_addresses') .' WHERE '. $db->quoteName('contact_id') .' = '.$rID;
                $db->setQuery($query);
      					$db->execute();
                ...
                $query = '
                SELECT T2.id FROM
                  '. $db->quoteName('#__apcefpb_rel_contacts_phones') .' T1
                ...
                // exclui o relacionamento
                $query = 'DELETE FROM '. $db->quoteName('#__apcefpb_rel_contacts_phones') .' WHERE '. $db->quoteName('contact_id') .' = '.$rID;
                $db->setQuery($query);
      					$db->execute();
                ...
                $query = '
                SELECT T2.id FROM
                  '. $db->quoteName('#__apcefpb_rel_contacts_socials') .' T1
                ...
                // exclui o relacionamento
                $query = 'DELETE FROM '. $db->quoteName('#__apcefpb_rel_contacts_socials') .' WHERE '. $db->quoteName('contact_id') .' = '.$rID;
                $db->setQuery($query);
                $db->execute();
                ...
                $query = '
                SELECT T2.id FROM
                  '. $db->quoteName('#__apcefpb_rel_contacts_banksAccounts') .' T1
                ...
                // exclui o relacionamento
                $query = 'DELETE FROM '. $db->quoteName('#__apcefpb_rel_contacts_banksAccounts') .' WHERE '. $db->quoteName('contact_id') .' = '.$rID;
                $db->setQuery($query);
      					$db->execute();
