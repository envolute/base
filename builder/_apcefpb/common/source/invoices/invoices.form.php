			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group field-required">
						...
						<select name="group_id" id="<?php echo $APPTAG?>-group_id" class="form-control auto-tab" data-target="<?php echo $APPTAG?>-month">
							<option value=""><?php echo JText::_('TEXT_SELECT'); ?></option>
							<option value="0">Sócios Efetivos</option>
							<option value="1">Contribuintes</option>
						</select>
					</div>
				</div>
				<div class="col-sm-3">
