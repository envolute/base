...
$query = 'SELECT * FROM '. $db->quoteName('#__apcefpb_employees') .' WHERE state = 1 ORDER BY name';
$db->setQuery($query);
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group field-required">
						...
						<select name="provider_id" id="<?php echo $APPTAG?>-provider_id" class="form-control field-id auto-tab" data-target="<?php echo $APPTAG?>-employee_id">
				...
				<div class="col-sm-6">
					<div class="form-group field-required">
						<label><?php echo JText::_('FIELD_LABEL_EMPLOYEE'); ?></label>
						<select name="employee_id" id="<?php echo $APPTAG?>-employee_id" class="form-control field-id auto-tab" data-target="<?php echo $APPTAG?>-description">
							<option value="0"><?php echo JText::_('TEXT_SELECT')?></option>
							<?php
