...
// crud's main table
  $cfg['mainTable']         = '#__apcefpb_comments';
...
// crud's relation actions
  ...
  if(!$ajaxRequest) :
    ...
    // relationed table APP -> tabela do APP relacionado. Ex: #__apcefpb_tasks, #__apcefpb_tickets
    ...
    // relationed table APP Contacts -> tabela de contatos do APP relacionado. Ex: #__apcefpb_contacts...
    $_SESSION[$RTAG.'TableAPPContacts'] = isset(${$APPTAG.'TableAPPContacts'}) ? ${$APPTAG.'TableAPPContacts'} : '';
    // relation table APP Contacts -> tabela de contatos do APP relacionado. Ex: #__apcefpb_rel_tasks_contacts...
