...
<div>
	<div class="<?php echo $className .'-category' . $displayData->pageclass_sfx;?>">
		<?php if ($params->get('show_page_heading') && $params->get('page_heading')) : ?>
		...
		<?php 
		if (
		($params->get('show_description') && $displayData->get('category')->description) || 
		($params->get('show_description_image') && $displayData->get('category')->getParams()->get('image'))
		) : ?>
