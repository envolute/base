...
// essa variável foi enviada por 'templates/base/source/template/error.php'
...
<div id="error">
	...
	<p class="alert alert-warning">
		...
		<span class="base-icon-info-circled"></span> <?php echo JText::_('JERROR_LAYOUT_PLEASE_CONTACT_THE_SYSTEM_ADMINISTRATOR'); ?>
	</p>
</div>
