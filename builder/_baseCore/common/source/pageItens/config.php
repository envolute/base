...
// content layout default
  $cfg['contentLayout']     = "<h2 class=\"no-margin-top\">{PAGEITEM TITLE}</h2>\r<p class=\"bottom-space-xl\">\r<a href=\"{PAGEITEM URLLIST}\">{PAGEITEM TAGNAME}</a>, {PAGEITEM DATE} \r{PAGEITEM MONTH} {PAGEITEM YEAR}\r</p>\r<div class=\"pageItens-content\">\r{PAGEITEM CONTENT}\r</div>";
