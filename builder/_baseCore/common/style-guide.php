...
// APP
	...
	// jQuery UI
	echo '
	<script src="core/libs/jquery/jquery-ui.min.js" type="text/javascript"></script>
	<link rel="stylesheet" href="core/libs/jquery/jquery-ui.min.css" type="text/css" />
	';
	// load BASE Scripts
	echo '
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div id="loader" class="progress progress-striped">
							<img src="<?php echo $base?>core/images/loader-active.gif">
