...
<body class="site <?php echo $option.$view.$layout.$task.$itemid.$pageclass.$screen.' '. $access; ?>">
	...
	<div id="screen" class="clearfix">
		...
		<?php
		// NAVBAR
		if(!empty($navbarAccess) && ($this->countModules('admin-add') || $this->countModules('admin-report') || $this->countModules('admin-menu') || $this->countModules('admin-helper'))) :
		...
		?>
		<nav id="navside" class="set-visible-height clearfix" data-offset-ids="#cmstools, #navtop">
		...
		<div id="wrapper">
			...
			<?php
			// TOP
			if($this->countModules('top') && !$hidePos):
			?>
			...
			<?php
			// NAVIGATION
			if($this->countModules('navigation') && !$hidePos):
			?>
			...
			<?php
			// SHOWCASE
			if($this->countModules('showcase') && !$hidePos):
			?>
			<div id="showcase">
				<div class="<?php echo $container?>">
					<div class="row">
			...
			if($this->countModules('info-top') && !$hidePos): ?>
			<div id="info-top">
				<div class="<?php echo $container?>">
					<div class="row">
						<div class="row-wrapper">
			...
			<?php
			// FEATURED
			if(($featCount > 0 || $this->countModules('full-featured')) && !$hidePos):
			?>
			<div id="featured">

				<?php if($this->countModules('full-featured')): ?>
					<jdoc:include type="modules" name="full-featured" style="mod" />
				<?php endif; ?>
			...
			<div id="full-content">
				...
				<?php if($this->countModules('full-content-top') && !$hidePos): ?>
					<jdoc:include type="modules" name="full-content-top" style="mod" />
				<?php endif; ?>
					...
					<div class="row">
						<div class="row-wrapper">
							<div class="row">
								...
								<?php if($this->countModules('all-content-top') && !$hidePos): ?>
									<!-- Main Content Top -->
									<div id="all-content-top" class="col-sm-12">
										<div class="row">
											<jdoc:include type="modules" name="all-content-top" style="mod" />
										</div>
									</div>
								<?php endif; ?>
								...
								<div id="main-content" class="<?php echo grid(setOffset($rightWidth + $leftWidth), $gDef);?>">
									...
									<?php if($this->countModules('main-content-top') && !$hidePos): ?>
										<!-- Main Content Top -->
										<div class="row">
											<div id="main-content-top" class="col-sm-12">
												<div class="row">
									...
									<div class="row">
										...
										<?php if(($this->countModules('sidebar') && $sidebarFloat == 'left') && !$hidePos): ?>
											<!-- Sidebar if [left] -->
										...
										<div id="content" class="<?php echo grid(setOffset($sidebarWidth), $gDef);?>">
											...
											<?php if($this->countModules('content-top') && !$hidePos): ?>
												<!-- Content Top -->
												<div id="content-top">
													<div class="row">
											...
											<?php if($this->countModules('content-bottom') && !$hidePos): ?>
												<!-- Content Bottom -->
										...
										<?php if(($this->countModules('sidebar') && $sidebarFloat == 'right') && !$hidePos): ?>
											<!-- Sidebar if [right] -->
											<div id="sidebar" class="<?php echo grid($sidebarWidth, $gDef);?>">
												<jdoc:include type="modules" name="sidebar" style="mod" />
											</div>
									...
									<?php if($this->countModules('main-content-bottom') && !$hidePos): ?>
										<!-- Main Content Bottom -->
										<div class="row">
											<div id="main-content-bottom" class="col-sm-12">
												<div class="row">
								...
								<?php if($this->countModules('all-content-bottom') && !$hidePos): ?>
									<!-- Main Content Top -->
									<div id="all-content-bottom" class="col-sm-12">
										<div class="row">
											<jdoc:include type="modules" name="all-content-bottom" style="mod" />
										</div>
									</div>
								<?php endif; ?>
				...
				<?php if($this->countModules('full-content-bottom') && !$hidePos): ?>
					<jdoc:include type="modules" name="full-content-bottom" style="mod" />
				<?php endif; ?>
			...
			if($this->countModules('info-bottom') && !$hidePos): ?>
			<!-- Info Bottom -->
			<div id="info-bottom">
				<div class="<?php echo $container?>">
					<div class="row">
			...
			<?php
			// SYNDICATE
			if(($syndCount > 0 || $this->countModules('full-syndicate')) && !$hidePos):
			?>
			<div id="syndicate">

				<?php if($this->countModules('full-syndicate')): ?>
					<jdoc:include type="modules" name="full-syndicate" style="mod" />
				<?php endif; ?>
			...
			<?php
			// BOTTOM
			if(($bottomCount > 0 || $this->countModules('full-bottom')) && !$hidePos):
			?>
			<div id="bottom">

				<?php if($this->countModules('full-bottom')): ?>
					<jdoc:include type="modules" name="full-bottom" style="mod" />
				<?php endif; ?>
