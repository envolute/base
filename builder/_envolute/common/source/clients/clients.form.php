	...
	<div class="modal-body">
		<fieldset>
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="form-group">
						<label class="iconTip hasTooltip" title="<?php echo JText::_('MSG_EMAIL_TO_PAYMENT'); ?>">E-mail <?php echo JText::_('TEXT_TO_PAYMENT'); ?></label>
						<input type="text" name="email_payment" id="<?php echo $APPTAG?>-email_payment" class="form-control field-email" />
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
