	...
	<div class="modal-body">
		<fieldset>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group field-required">
						<label><?php echo JText::_('FIELD_LABEL_SPACE'); ?></label>
						<span class="input-group">
							<input type="number" name="space" id="<?php echo $APPTAG?>-space" size="2" class="form-control" />
							<span class="input-group-addon cursor-help hasTooltip" title="Gigabites">GB</span>
						</span>
					</div>
				</div>
				<div class="col-sm-3">
