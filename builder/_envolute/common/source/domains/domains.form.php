...
$query = 'SELECT * FROM '. $db->quoteName($cfg['mainTable'].'_providers') .' WHERE state = 1 ORDER BY name';
$db->setQuery($query);
	...
	<div class="modal-body">
		<fieldset>
			...
			<div class="row">
				<div class="col-sm-9">
					<div class="form-group field-required">
						<label><?php echo JText::_('FIELD_LABEL_HOST'); ?></label>
						<div class="input-group">
							<select name="host_id" id="<?php echo $APPTAG?>-host_id" class="form-control field-id"></select>
							<span class="input-group-btn">
								<button type="button" class="base-icon-plus btn btn-success hasTooltip" title="<?php echo JText::_('TEXT_ADD')?>" data-toggle="modal" data-target="#modal-hosts" data-backdrop="static" data-keyboard="false"></button>
								<button type="button" class="base-icon-pencil btn btn-warning hasTooltip" title="<?php echo JText::_('TEXT_EDIT')?>" onclick="<?php echo $APPTAG?>_editHost()"></button>
							</span>
						</div>
					</div>
				</div>
				<div class="col-sm-9">
					<div class="form-group field-required">
						<label><?php echo JText::_('FIELD_LABEL_DOMAIN'); ?></label>
						<span class="input-group">
							<span class="input-group-addon">www.</span>
							<input type="text" name="domain" id="<?php echo $APPTAG?>-domain" class="form-control" />
						</span>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="btn-group" data-toggle="buttons">
							<label class="btn btn-warning btn-active-success hasTooltip" title="<?php echo JText::_('FIELD_LABEL_MAIN_DESC'); ?>">
				...
				<div class="col-sm-9">
					<div class="form-group field-required">
						...
						<div class="input-group">
							<select name="provider" id="<?php echo $APPTAG?>-provider" class="form-control auto-tab" data-target="<?php echo $APPTAG?>-date">
							...
							<span class="input-group-btn">
								<button type="button" class="base-icon-plus btn btn-success hasTooltip" title="<?php echo JText::_('TEXT_ADD')?>" data-toggle="modal" data-target="#modal-<?php echo $APPTAG?>Providers" data-backdrop="static" data-keyboard="false"></button>
								<button type="button" class="base-icon-cog btn btn-primary hasTooltip" title="<?php echo JText::_('TEXT_EDIT')?>" onclick="<?php echo $APPTAG?>Providers_listReload(false)" data-toggle="modal" data-target="#modal-list-<?php echo $APPTAG?>Providers" data-backdrop="static" data-keyboard="false"></button>
							</span>
						</div>
					</div>
				</div>
