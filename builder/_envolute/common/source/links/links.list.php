	...
	<form id="form-list-'.$APPTAG.'" method="post">
		<table class="table table-striped table-hover table-condensed">
			<thead>
				<tr>
					'.$adminView['head']['info'].'
					<th>'.$$SETOrder(JText::_('FIELD_LABEL_TYPE'), 'T1.type', $APPTAG).'</th>
					<th>'.$$SETOrder(JText::_('FIELD_LABEL_URL'), 'T1.url', $APPTAG).'</th>
					<th>'.$$SETOrder(JText::_('FIELD_LABEL_CATEGORY'), 'T2.name', $APPTAG).'</th>
					<th width="120" class="text-center">'.$$SETOrder(JText::_('FIELD_LABEL_PAID'), 'T1.paid', $APPTAG).'</th>
