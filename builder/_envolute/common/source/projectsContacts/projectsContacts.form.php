...
$query = '
SELECT T1.id, CONCAT(T1.name," - ",T2.name) project FROM
			...
			<div class="row">
				<div class="col-sm-8">
					<div class="form-group field-required">
						...
						<select name="project_id" id="<?php echo $APPTAG?>-project_id" class="form-control field-id auto-tab" data-target="<?php echo $APPTAG?>-contact_id">
				...
				<div class="col-sm-8">
					<div class="form-group field-required">
						...
						<div class="input-group">
							...
							<span id="groupAdd-client-contact" class="input-group-btn hide">
								<button type="button" onclick="contacts_setRelation(projectClientId)" class="base-icon-plus btn btn-success hasTooltip" title="<?php echo JText::_('TEXT_ADD')?>" data-toggle="modal" data-target="#modal-contacts" data-backdrop="static" data-keyboard="false"></button>
				...
				<div class="col-sm-8">
					<div class="form-group">
						...
						<input type="text" name="role" id="<?php echo $APPTAG?>-role" class="form-control" />
					</div>
				</div>
				<div class="col-sm-12">
