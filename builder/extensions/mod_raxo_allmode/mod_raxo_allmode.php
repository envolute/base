...
// Module layout name
$module_layout	= $params->get('layout', '_:raxo-columns');
...
// ORIGINAL: $module_class	= trim('allmode-box '. $layout_name .' '. $module_class);
// CUSTOM -> remove a 'module_class' pois ela já é carregada no módulo (evita duplicidade)
$module_class	= trim('allmode-box '. $layout_name);
?>
