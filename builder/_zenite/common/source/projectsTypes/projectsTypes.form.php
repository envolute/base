...
$query = 'SELECT * FROM '. $db->quoteName('#__zenite_projects_categories') .' WHERE state = 1 ORDER BY name';
$db->setQuery($query);
$categories = $db->loadObjectList();

$query = 'SELECT * FROM '. $db->quoteName('#__zenite_disabilities') .' WHERE state = 1 ORDER BY id';
$db->setQuery($query);
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group field-required">
						...
						<div class="input-group">
							<select name="category_id" id="<?php echo $APPTAG?>-category_id" class="form-control field-id">
								<option value="0">- <?php echo JText::_('TEXT_SELECT'); ?> -</option>
								<?php
							...
							<span class="input-group-btn">
								<button type="button" class="base-icon-plus btn btn-success hasTooltip" title="<?php echo JText::_('TEXT_ADD')?>" data-toggle="modal" data-target="#modal-projectsCategories" data-backdrop="static" data-keyboard="false"></button>
								<button type="button" class="base-icon-cog btn btn-primary hasTooltip" title="<?php echo JText::_('TEXT_EDIT')?>" onclick="projectsCategories_listReload(false)" data-toggle="modal" data-target="#modal-list-projectsCategories" data-backdrop="static" data-keyboard="false"></button>
							</span>
						</div>
					</div>
				</div>
					...
					<div class="form-group">
						...
						<span class="btn-group btn-group-justified" data-toggle="buttons">
							<label class="btn btn-default btn-active-success">
								<input type="radio" name="gender" id="<?php echo $APPTAG?>-gender-0" value="0" />
								<?php echo JText::_('TEXT_BOTH'); ?>
							</label>
							<label class="btn btn-default btn-active-success">
								<input type="radio" name="gender" id="<?php echo $APPTAG?>-gender-1" value="1" />
								<?php echo JText::_('TEXT_MALE'); ?>
							</label>
							<label class="btn btn-default btn-active-success">
								<input type="radio" name="gender" id="<?php echo $APPTAG?>-gender-2" value="2" />
								<?php echo JText::_('TEXT_FEMALE'); ?>
							</label>
						</span>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						<label><?php echo JText::_('FIELD_LABEL_DISABILITY'); ?></label>
						<div class="input-group">
							<select name="disability_id" id="<?php echo $APPTAG?>-disability_id" class="form-control field-id auto-tab" data-target="<?php echo $APPTAG?>-name">
								<option value="0">- <?php echo JText::_('TEXT_SELECT'); ?> -</option>
								<?php
							...
							<span class="input-group-btn">
								<button type="button" class="base-icon-plus btn btn-success hasTooltip" title="<?php echo JText::_('TEXT_ADD')?>" data-toggle="modal" data-target="#modal-disabilities" data-backdrop="static" data-keyboard="false"></button>
								<button type="button" class="base-icon-cog btn btn-primary hasTooltip" title="<?php echo JText::_('TEXT_EDIT')?>" onclick="disabilities_listReload(false)" data-toggle="modal" data-target="#modal-list-disabilities" data-backdrop="static" data-keyboard="false"></button>
							</span>
						</div>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group field-required">
						<label><?php echo JText::_('FIELD_LABEL_DISTANCE'); ?></label>
						<input type="number" name="distance" id="<?php echo $APPTAG?>-distance" class="form-control" />
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						...
						<span class="btn-group btn-group-justified" data-toggle="buttons">
							<label class="btn btn-default btn-active-success hasTooltip" title="<?php echo JText::_('FIELD_LABEL_KM_DESC'); ?>">
								<input type="radio" name="distance_unit" id="<?php echo $APPTAG?>-distance_unit-1" value="1" />
								Km
							</label>
							<label class="btn btn-default btn-active-success hasTooltip" title="<?php echo JText::_('FIELD_LABEL_M_DESC'); ?>">
								<input type="radio" name="distance_unit" id="<?php echo $APPTAG?>-distance_unit-0" value="0" />
								m
							</label>
						</span>
					</div>
				...
				<div class="col-sm-3">
					<div class="form-group field-required">
						<label><?php echo JText::_('FIELD_LABEL_MIN_AGE'); ?></label>
						<div class="input-group">
							<input type="number" name="min_age" id="<?php echo $APPTAG?>-min_age" class="form-control" />
							<span class="input-group-addon"><?php echo JText::_('TEXT_YEARS'); ?></span>
						</div>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label><?php echo JText::_('FIELD_LABEL_MAX_AGE'); ?></label>
						<div class="input-group">
							<input type="number" name="max_age" id="<?php echo $APPTAG?>-max_age" class="form-control" />
							<span class="input-group-addon"><?php echo JText::_('TEXT_YEARS'); ?></span>
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						<label><?php echo JText::_('FIELD_LABEL_AGE_TYPE'); ?></label>
						<span class="btn-group btn-group-justified" data-toggle="buttons">
							<label class="btn btn-default btn-active-success hasTooltip" title="<?php echo JText::_('FIELD_LABEL_AGE_TYPE_0_DESC'); ?>">
								<input type="radio" name="age_type" id="<?php echo $APPTAG?>-age_type-0" value="0" />
								<?php echo JText::_('FIELD_LABEL_AGE_TYPE_0'); ?>
							</label>
							<label class="btn btn-default btn-active-success hasTooltip" title="<?php echo JText::_('FIELD_LABEL_AGE_TYPE_1_DESC'); ?>">
								<input type="radio" name="age_type" id="<?php echo $APPTAG?>-age_type-1" value="1" />
								<?php echo JText::_('FIELD_LABEL_AGE_TYPE_1'); ?>
							</label>
						</span>
					</div>
				</div>
				<div class="col-sm-9">
					<div class="form-group">
						...
						<textarea rows="4" name="description" id="<?php echo $APPTAG?>-description" class="form-control" style="height:102px;"></textarea>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="form-group">
						<label class="iconTip hasTooltip" title="<?php echo JText::_('FIELD_LABEL_LINK_MAP_DESC'); ?>"><?php echo JText::_('FIELD_LABEL_LINK_MAP'); ?></label>
						<input type="text" name="link_map" id="<?php echo $APPTAG?>-link_map" class="form-control field-url" placeholder="http://" />
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label class="iconTip hasTooltip" title="<?php echo JText::_('FIELD_LABEL_IMAGE_MAP_DESC'); ?>"><?php echo JText::_('FIELD_LABEL_IMAGE_MAP'); ?></label><br />
