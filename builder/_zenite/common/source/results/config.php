...
// crud's main table
  $cfg['mainTable']         = '#__zenite_results';
...
// crud's upload config
  ...
  if($cfg['hasUpload']) :
    ...
    $cfg['fileTable']       = $cfg['mainTable'].'_file70s'; // upload's database table
    // upload params
    ...
    $cfg['fileTypes']       = array();
      ...
      $cfg['fileTypes']['file'][]  = 'application/octet-stream';
      ...
      $cfg['fileTypes']['file'][]  = 'application/csvm+json';
      $cfg['fileTypes']['file'][]  = 'application/csv';
      $cfg['fileTypes']['file'][]  = 'text/csv';
