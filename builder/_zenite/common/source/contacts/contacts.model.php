          ...
          $uList = $db->loadObjectList();
            ...
            if(!empty($_SESSION[$RTAG.'RelTable']) && !empty($_SESSION[$RTAG.'AppNameId'])) :
              ...
              foreach ($rIDs as $rID) {
                ...
                $query = '
                SELECT T2.id FROM
                  '. $db->quoteName('#__zenite_rel_contacts_addresses') .' T1
                ...
                $query = 'DELETE FROM '. $db->quoteName('#__zenite_rel_contacts_addresses') .' WHERE '. $db->quoteName('contact_id') .' = '.$rID;
                $db->setQuery($query);
      					$db->execute();
                ...
                $query = '
                SELECT T2.id FROM
                  '. $db->quoteName('#__zenite_rel_contacts_phones') .' T1
                ...
                // exclui o relacionamento
                $query = 'DELETE FROM '. $db->quoteName('#__zenite_rel_contacts_phones') .' WHERE '. $db->quoteName('contact_id') .' = '.$rID;
                $db->setQuery($query);
      					$db->execute();
                ...
                $query = '
                SELECT T2.id FROM
                  '. $db->quoteName('#__zenite_rel_contacts_socials') .' T1
                ...
                // exclui o relacionamento
                $query = 'DELETE FROM '. $db->quoteName('#__zenite_rel_contacts_socials') .' WHERE '. $db->quoteName('contact_id') .' = '.$rID;
                $db->setQuery($query);
                $db->execute();
                ...
                $query = '
                SELECT T2.id FROM
                  '. $db->quoteName('#__zenite_rel_contacts_banksAccounts') .' T1
                ...
                // exclui o relacionamento
                $query = 'DELETE FROM '. $db->quoteName('#__zenite_rel_contacts_banksAccounts') .' WHERE '. $db->quoteName('contact_id') .' = '.$rID;
                $db->setQuery($query);
      					$db->execute();
