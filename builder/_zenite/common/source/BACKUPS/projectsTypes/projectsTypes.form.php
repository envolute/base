...
$query = 'SELECT * FROM '. $db->quoteName('#__zenite_projects') .' WHERE state = 1 ORDER BY date DESC';
$db->setQuery($query);
...
$query = 'SELECT * FROM '. $db->quoteName('#__zenite_disabilities') .' WHERE state = 1 ORDER BY name';
$db->setQuery($query);
