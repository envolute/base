...
// crud's main table
  $cfg['mainTable']         = '#__zenite_comments';
...
// crud's relation actions
  ...
  if(!$ajaxRequest) :
    ...
    // relationed table APP -> tabela do APP relacionado. Ex: #__zenite_tasks, #__zenite_tickets
    ...
    // relationed table APP Contacts -> tabela de contatos do APP relacionado. Ex: #__zenite_contacts...
    $_SESSION[$RTAG.'TableAPPContacts'] = isset(${$APPTAG.'TableAPPContacts'}) ? ${$APPTAG.'TableAPPContacts'} : '';
    // relation table APP Contacts -> tabela de contatos do APP relacionado. Ex: #__zenite_rel_tasks_contacts...
