...
// crud's main table
  $cfg['mainTable']         = '#__zenite_projects';
...
// crud's upload config
  ...
  if($cfg['hasUpload']) :
    ...
    $cfg['fileTypes']       = array();
      ...
      // $cfg['fileTypes'][]   = 'application/x-compressed';
      // $cfg['fileTypes'][]   = 'application/zip';
      // $cfg['fileTypes'][]   = 'application/x-zip';
      // $cfg['fileTypes'][]   = 'application/pdf';
      // $cfg['fileTypes'][]   = 'application/msword';
      // $cfg['fileTypes'][]   = 'application/excel';
      // $cfg['fileTypes'][]   = 'application/vnd.ms-excel';
      // $cfg['fileTypes'][]   = 'application/x-excel';
      // $cfg['fileTypes'][]   = 'application/x-msexcel';
  endif;
