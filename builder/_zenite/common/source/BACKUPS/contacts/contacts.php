	...
	// métodos controladores do formulário
		...
		window.<?php echo $APPTAG?>_formReset = function() {
			...
			email_optional.val('');
				...
				jQuery('#group-email_optional').addClass('hide');
				jQuery('#setEmailOptional').addClass('base-icon-plus').removeClass('base-icon-down-big').prop('disabled', false); // enable add button
			birthday.val('');
			occupation.val('');
			description.val('');
		...
		jQuery('#setEmailOptional').click(function() {
			jQuery(this).tooltip('hide');
			jQuery('#group-email_optional').removeClass('hide');
		...
		window.<?php echo $APPTAG?>_viewSocials = function() {
			var itemID = formId.val();
			webSocials_listReload(false, false, false, false, false, itemID);
		};
						...
						email_optional.val(item.email_optional);
							...
							if(item.email_optional == '') {
								...
								jQuery('#setEmailOptional').addClass('base-icon-plus').removeClass('base-icon-down-big').prop('disabled', false); // enable add button
									...
									jQuery('#setEmailOptional').trigger('click');
							}
	...
	<?php if($cfg['hasUpload']): ?>
		mainForm_<?php echo $APPTAG?>.find("input:file").each(function() {
			...
			obj.rules("add", {
				...
				accept: "<?php echo implode(',', $cfg['fileTypes'])?>",
				messages: {
