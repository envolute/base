...
$query = 'SELECT * FROM '. $db->quoteName('#__zenite_banks') .' WHERE state = 1 ORDER BY name';
$db->setQuery($query);
				...
				<div class="col-sm-8">
					<div class="form-group field-required">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button type="button" class="base-icon-plus btn btn-success hasTooltip" title="<?php echo JText::_('TEXT_ADD')?>" data-toggle="modal" data-target="#modal-banks" data-backdrop="static" data-keyboard="false"></button>
							</span>
						</div>
					</div>
				</div>
