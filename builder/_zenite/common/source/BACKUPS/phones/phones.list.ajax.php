...
if(isset($_SERVER["HTTP_X_REQUESTED_WITH"]) AND strtolower($_SERVER["HTTP_X_REQUESTED_WITH"]) == "xmlhttprequest") :
	...
	if($num_rows) : // verifica se existe
		...
		foreach($res as $item) {
			...
			$info = !empty($item->description) ? '<br /><small class="text-muted font-featured cursor-help">'.baseHelper::nameFormat($item->description).'</small>' : '';
			...
			$html .= '
				<li class="'.$rowState.'">
					...
					'.$item->phone_number.$main.$operator.$info.'
				</li>
			';
		}
		$html .= '</ul>';
