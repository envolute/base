	...
	<div class="modal-body">
		<fieldset>
			...
			<div class="row">
				<div class="col-sm-7">
					<div class="form-group field-required">
						...
						<div class="input-group">
							...
							<input type="hidden" name="cproject_id" id="<?php echo $APPTAG?>-cproject_id" />
						</div>
					</div>
				</div>
				<div class="col-sm-7">
				...
				<div class="col-sm-5">
					<div class="form-group">
						<label class="iconTip hasTooltip" title="<?php echo JText::_('FIELD_LABEL_FILE_DESC'); ?>"><?php echo JText::_('FIELD_LABEL_FILE'); ?></label><br />
