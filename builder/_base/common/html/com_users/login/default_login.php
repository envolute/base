...
<div class="login">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-validate">
		<fieldset>
			...
			?>
			<a class="btn btn-warning pull-left right-space-sm hasTooltip" title="<?php echo JText::_('COM_USERS_LOGIN_REGISTER'); ?>" href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>">
