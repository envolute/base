	...
	<div class="userdata">
		...
		<?php
			...
			<?php if ($usersConfig->get('allowUserRegistration')) : ?>
				<a class="btn btn-warning pull-left right-space-sm hasTooltip" title="<?php echo JText::_('MOD_LOGIN_REGISTER'); ?>" href="<?php echo JRoute::_('index.php?option=com_users&view=registration&Itemid=' . UsersHelperRoute::getRegistrationRoute()); ?>">
					<span class="base-icon-user-add"></span>
				</a>
			<?php endif; ?>
			<ul class="list-unstyled text-sm no-margin pull-left">
