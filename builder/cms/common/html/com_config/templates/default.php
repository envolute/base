...
<form action="<?php echo JRoute::_('index.php?option=com_config'); ?>" method="post" name="adminForm" id="templates-form" class="form-validate edit">
	...
	<div class="row">
		<div class="col-md-6">
			<h4 class="page-header"><span class="base-icon-cog"></span> <?php echo JText::_('COM_CONFIG_TEMPLATE_SETTINGS'); ?></h4>
