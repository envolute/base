...
<div class="row">
	<div class="col-lg-9">
		...
		<section id="brands">
			...
			<h1 class="page-header">Brands<span class="label label-warning text-md pull-right top-space">BASE</span></h1>

			<div class="row">
				<div class="col-lg-3 col-lg-offset-3">
					<hr class="hr-label" /><span class="label pull-none bottom-space">Original</span>
					<img src="images/template/logos/logo.png" class="img-responsive obj-to-center hasTooltip cursor-help" title="logo.png" />
				</div>
				<div class="col-lg-3">
					<hr class="hr-label" /><span class="label pull-none bottom-space">Site</span>
					<img src="images/template/logos/logo-site.png" class="img-responsive obj-to-center hasTooltip cursor-help" title="logo-site.png" />
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3">
					<hr class="hr-label" /><span class="label pull-none bottom-space">Favicon</span>
					<img src="templates/base/favicon.ico" class="img-responsive obj-to-center hasTooltip cursor-help" title="favicon.ico" />
				</div>
				<div class="col-lg-3">
					<hr class="hr-label" /><span class="label pull-none bottom-space">Offline</span>
					<img src="images/template/logos/logo-off.png" class="img-responsive obj-to-cente hasTooltip cursor-help" title="logo-off.pngr" />
				</div>
				<div class="col-lg-3">
					<hr class="hr-label" /><span class="label pull-none bottom-space">Newsletter</span>
					<img src="images/template/logos/logo-news.png" class="img-responsive obj-to-center hasTooltip cursor-help" title="logo-news.png" />
				</div>
				<div class="col-lg-3">
					<hr class="hr-label" /><span class="label pull-none bottom-space">Administrator</span>
					<img src="images/template/logos/logo-admin.png" class="img-responsive obj-to-center hasTooltip cursor-help" title="logo-admin.png" />
				</div>
			</div>
		...
		<section id="forms">
			...
			<div class="well">
				<h4 id="form-base" class="page-header">Additional Options for Forms <span class="label label-warning pull-right">BASE</span></h4>
				<div class="row">
					<div class="col-lg-6">
...
&lt;/ul&gt;
		...
		<section id="indicators">
			...
			<div class="well">
				<h4 class="page-header"><span class="base-icon-star text-live"></span> Alerts Context Icons<span class="label label-warning pull-right">BASE</span></h2>
				<div class="row">
					<div class="col-lg-6">
	...
	<div class="col-lg-3">
		...
		<nav id="guide-menu" class="set-border border-default color-muted-lighter text-sm set-parent-width">
			<ul class="nav list-menu">
				...
				<li><a href="#indicators">Alerts, Labels & Badges</a></li>
