...
<?php echo '<fieldset><legend class="ev_fieldset">' . JText::_('JEV_SEARCHRESULTS'). '</legend>'; ?>

<table align="center" width="90%" cellspacing="0" cellpadding="5" class="ev_table table-striped">
   <tr valign="top">
       <th colspan="2"  align="center" class="cal_td_daysnames">
