...
$hasevents = false;
	...
	echo '<fieldset><legend class="ev_fieldset">' . JText::_('JEV_EVENTSFORTHE') . '</legend>' . "\n";
	echo '<table align="center" width="90%" cellspacing="0" cellpadding="5" class="ev_table table-striped">' . "\n";
	?>
	<tr valign="top">
