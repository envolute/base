...
<div class="row">
	<div class="col-sm-6 col-lg-4">
		<div class="form-group field-required">
			<label><?php echo JText::_('FIELD_LABEL_TRANSACTION_TYPE'); ?></label>
	...
	<div class="col-sm-6 col-lg-4">
		<div class="form-group field-required">
			...
			<span class="btn-group btn-group-justified" data-toggle="buttons">
				<label class="btn btn-default btn-active-success">
					<input type="radio" name="isCard" id="<?php echo $APPTAG?>-isCard-0" value="0" onchange="<?php echo $APPTAG?>_setCard(0)" />
					<?php echo JText::_('TEXT_NO'); ?>
				</label>
				<label class="btn btn-default btn-active-success">
					<input type="radio" name="isCard" id="<?php echo $APPTAG?>-isCard-1" value="1" onchange="<?php echo $APPTAG?>_setCard(1)" />
