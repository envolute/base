	...
	foreach($res as $item) {
					...
					<table class="table table-striped table-hover table-sm">
						<thead>
							<tr>
								...
								<th width="60" class="text-right"><span class="cursor-help hasTooltip" title="'.JText::_('FIELD_LABEL_ICON_DESC').'">'.JText::_('FIELD_LABEL_ICON').'</th>
		...
		$html .= '
			<tr id="'.$APPTAG.'-item-'.$item->id.'" class="'.$rowState.'">
				...
				<td class="text-right">'.$item->icon.'</td>
