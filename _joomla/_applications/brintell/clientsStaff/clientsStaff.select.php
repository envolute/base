...
?>
	...
	<div class="hidden-print b-bottom mb-3 pb-3 clearfix">
			...
			<select name="vID" id="<?php echo $APPTAG?>-vID" class="form-control" onchange="<?php echo $APPTAG?>_selectItem(this)">
				...
				<?php
					...
					foreach ($contacts as $obj) {
						...
						if($vID == $obj->id) $contactName = baseHelper::nameFormat($obj->name);
					}
				?>
			</select>
		...
		<div class="btn-group float-right d-none d-md-flex">
			<a href="<?php echo JURI::root()?>apps/base-contacts" class="btn btn-default base-icon-cog"><span class="d-none d-lg-inline"> <?php echo JText::_('LIST_TITLE')?></span></a>
