		...
		<div class="form-group field-required">
			...
			<div class="input-group">
				...
				<span class="input-group-btn">
					<button type="button" onclick="staff_setRelation(<?php echo $APPTAG?>rID)" class="base-icon-plus btn btn-success hasTooltip" title="<?php echo JText::_('TEXT_ADD')?>" data-toggle="modal" data-target="#modal-staff" data-backdrop="static" data-keyboard="false"></button>
					<button type="button" class="base-icon-pencil btn btn-warning hasTooltip" title="<?php echo JText::_('TEXT_EDIT')?>" onclick="<?php echo $APPTAG?>_editStaff()"></button>
				</span>
			</div>
		</div>
	</div>
