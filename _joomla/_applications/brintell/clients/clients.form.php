						...
						<div class="form-group">
							...
							<span class="btn-group btn-group-justified" data-toggle="buttons">
								...
								<label class="btn btn-default btn-active-success">
									<input type="radio" name="portfolio" id="<?php echo $APPTAG?>-portfolio-1" value="1" />
...
<?php if(!$cfg['itemView']) :?>
	<div id="<?php echo $APPTAG?>-msg-relations" class="alert alert-info base-icon-info-circled">
		<span class="text-live font-featured"><?php echo JText::_('TEXT_STAFF')?></span>,
	...
	<div id="<?php echo $APPTAG?>-buttons-relations" hidden>
		...
		<div class="row">
			<div class="col-6 col-lg-3 py-1">
				<button type="button" class="btn btn-primary btn-block base-icon-user-add btn-icon" onclick="<?php echo $APPTAG?>_viewStaff()" data-toggle="modal" data-target="#modal-list-clientsStaff" data-backdrop="static" data-keyboard="false"> <?php echo JText::_('TEXT_STAFF')?></button>
			</div>
			<div class="col-6 col-lg-3 py-1">
			...
			<div class="col-6 col-lg-3 py-1">
				<button type="button" class="btn btn-primary btn-block base-icon-bank btn-icon" onclick="<?php echo $APPTAG?>_viewBanks()" data-toggle="modal" data-target="#modal-list-_banksAccountsClients" data-backdrop="static" data-keyboard="false"> <?php echo JText::_('TEXT_BANKS_ACCOUNTS')?></button>
			</div>
		</div>
	</div>
<?php endif;?>
