					...
					<div class="col-lg-6 <?php echo $APPTAG?>-groupType-client">
						<div class="form-group">
							...
							<div id="<?php echo $APPTAG?>-btn-clients" hidden>
								<button type="button" class="btn btn-primary btn-block text-left base-icon-list btn-icon" onclick="<?php echo $APPTAG?>_viewClients()" data-toggle="modal" data-target="#modal-list-<?php echo $APPTAG?>Clients" data-backdrop="static" data-keyboard="false"> <?php echo JText::_('TEXT_ASSIGN_TO_TEAM')?></button>
							</div>
						</div>
					</div>
					<div class="col-12">
