...
// list view
$urlToView = JURI::root().'apps/'.$APPPATH.'/portfolio-view';
...
$html = '
	...
	<div id="portfolio-filter" class="hidden-print my-3">
...
if($num_rows) : // verifica se existe
	$html .= '<div id="portfolio-list" class="row pt-4">';
	foreach($res as $item) {

		JLoader::register('uploader', JPATH_CORE.DS.'helpers/files/upload.php');
		// Imagem Principal -> Primeira imagem (index = 0)
		$img = uploader::getFile($cfg['fileTable'], '', $item->id, 0, $cfg['uploadDir']);
		if(!empty($img)) $img = '<img src="'.baseHelper::thumbnail('images/apps/'.$APPPATH.'/'.$img['filename'], 150, 150).'" class="img-fluid mb-3 mx-auto set-shadow" />';
		...
		$html .= '
			<div class="portfolio-item col-md-4 col-xl-3 text-center my-4">
