		...
		<div class="row">
			<div class="col-lg-8">
				<div class="row">
					...
					<div class="col-lg-5">
						<div class="form-group">
							...
							<input type="text" name="requests" id="<?php echo $APPTAG?>-requests" class="form-control" />
						</div>
					</div>
					<div class="col-lg-7">
						<div class="form-group field-required">
				...
				<div class="form-group">
					...
					<textarea rows="10" name="description" id="<?php echo $APPTAG?>-description" class="form-control" style="height:102px;"></textarea>
				</div>
