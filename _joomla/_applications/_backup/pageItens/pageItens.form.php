		  ...
		  <div class="tab-content">
		    <div role="tabpanel" class="tab-pane active" id="tab<?php echo $APPTAG?>Main">
						...
						<div class="col-sm-8">
							<div id="<?php echo $APPTAG?>-cover-0" class="form-group">
								<span class="btn-group">
									<button type="button" class="base-icon-search btn btn-default file-action"> <?php echo JText::_('TEXT_IMAGE_SELECT'); ?></button>
								</span>
								<input type="file" name="file[0]" id="<?php echo $APPTAG?>-file0" class="form-control" hidden />
							</div>
							<div id="<?php echo $APPTAG?>-cover-1" class="form-group" hidden>
				...
				<div role="tabpanel" class="tab-pane" id="tab<?php echo $APPTAG?>Content">
					<div class="row">
						<div class="col-sm-12"<?php if($_SESSION[$RTAG.'OnlyContentDef']) echo ' hidden'?>>
							<div class="form-group">
								<span class="btn-group w-full" data-toggle="buttons">
						...
						<?php if($_SESSION[$RTAG.'ContentTypeDef'] == 0 || $_SESSION[$RTAG.'FormShowLinkContent'] == 1) :?>
							<div id="<?php echo $APPTAG?>-group-0" hidden>
								<div class="col-sm-8">
									<div class="form-group">
						...
						<?php endif;?>
						<?php if($_SESSION[$RTAG.'ContentTypeDef'] == 1 || $_SESSION[$RTAG.'FormShowFileContent'] == 1) :?>
							<div id="<?php echo $APPTAG?>-group-1" class="col-sm-12" hidden>
								<div class="form-group">
						...
						<?php endif;?>
						<?php if($_SESSION[$RTAG.'ContentTypeDef'] == 2 || $_SESSION[$RTAG.'FormShowTextContent'] == 1) :?>
							<div id="<?php echo $APPTAG?>-group-2" class="col-sm-12" hidden>
								<!-- Nav tabs -->
										...
										<div class="row">
											<div class="col-sm-5">
												<div class="form-group">
													...
													<div class="btn-group w-full" data-toggle="buttons">
														<label class="col btn btn-default btn-active-danger">
						...
						<?php endif;?>
						<?php if($_SESSION[$RTAG.'ContentTypeDef'] == 3 || $_SESSION[$RTAG.'FormShowGalleryContent'] == 1) :?>
							<div id="<?php echo $APPTAG?>-group-3" class="col-sm-12" hidden>
								<hr class="my-sm" />
								<div class="row">
									<div class="col-6 col-sm-3">
										<div class="form-group">
											<span class="btn-group">
												<button type="button" class="base-icon-search btn btn-default file-action"></button>
											</span>
											<input type="file" name="file[2]" id="<?php echo $APPTAG?>-file2" class="form-control field-image" hidden />
										</div>
									</div>
							...
							<div role="tabpanel" class="tab-pane" id="tab<?php echo $APPTAG?>ConfigContent">
								<div class="row">
									<div class="col-sm-8">
										...
										<div class="text-xs text-muted font-featured mb-1"><?php echo JText::_('FIELD_LABEL_URL_LIST_DESC'); ?></div>
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
										...
										<div class="text-xs text-muted font-featured mb-1"><?php echo JText::_('FIELD_LABEL_URL_CONTENT_DESC'); ?></div>
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
