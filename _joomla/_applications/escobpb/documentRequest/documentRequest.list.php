	...
	foreach($res as $item) {
		...
		$html .= '
			<tr id="'.$APPTAG.'-item-'.$item->id.'" class="'.$rowState.'">
				'.$adminView['list']['info'].'
				<td>'.$item->name.'<br /><small class="font-featured text-live cursor-help hasTooltip" data-animation="false" title="'.JText::_('FIELD_LABEL_TYPE').'">'.baseHelper::nameFormat($item->type).'</small></td>
