...
jQuery(function() {
	...
	// métodos controladores do formulário
		...
		window.<?php echo $APPTAG?>_printCard = function(itemID){
			...
			var urlPrint = '<?php echo JURI::root()?>apps/employees/<?php echo $APPTAG?>-card?uID='+cID+'&tmpl=component';
			...
			jQuery.ajax({
				...
				success: function(data) {
					...
					jQuery.map( data, function( item ) {
						...
						driver.selectUpdate(item.driver); // select
						...
						partner_birthday.val(dateFormat(item.partner_birthday)); // DATE -> conversão de data
