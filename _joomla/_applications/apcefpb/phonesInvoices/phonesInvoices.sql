--
-- Estrutura da tabela `cms_apcefpb_phones_invoices`
--

CREATE TABLE IF NOT EXISTS `cms_apcefpb_phones_invoices` (
...
--
-- Estrutura da tabela `cms_apcefpb_phones_invoices_details`
--

CREATE TABLE IF NOT EXISTS `cms_apcefpb_phones_invoices_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Estrutura da tabela `cms_apcefpb_phones_invoices_files`
--

CREATE TABLE IF NOT EXISTS `cms_apcefpb_phones_invoices_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE OR REPLACE VIEW `vw_apcefpb_phones_invoices_phone_total` AS
SELECT
...
(
	(
		(
			(
				(
					(`cms_apcefpb_phones_invoices_details` `T1`
						left join `cms_apcefpb_phones_invoices` `T2`
		...
		left join `cms_apcefpb_clients` `T6`
...
CREATE OR REPLACE VIEW `vw_apcefpb_phones_invoices_summary` AS
SELECT
	`T1`.`invoice_id` AS `invoice_id`,
	`T3`.`id` AS `phone_id`,
	`T1`.`tel` AS `tel`,
