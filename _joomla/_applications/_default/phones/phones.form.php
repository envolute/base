			...
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group field-required">
						...
						<input type="hidden" name="country_code" id="<?php echo $APPTAG?>-country_code" />
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="btn-group width-full" data-toggle="buttons">
							<label class="col btn btn-warning btn-block btn-active-success">
				...
				<div class="col-sm-2">
					<div class="form-group">
						<label class="display-block">&#160;</label>
						<div class="btn-group width-full" data-toggle="buttons">
							<label class="col btn btn-default btn-block btn-active-success hasTooltip" title="<?php echo JText::_('TEXT_HAS_WHATSAPP'); ?>">
