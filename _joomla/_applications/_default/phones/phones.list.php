		...
		<table class="table table-striped table-hover table-sm">
			<thead>
				<tr>
					...
					<th>'.JText::_('FIELD_LABEL_PHONE_NUMBER').' '.baseAppHelper::linkOrder('[ <span class="base-icon-whatsapp hasTooltip" title="'.JText::_('TEXT_ORDER_WHATSAPP').'"></span> ]', 'T1.whatsapp', $APPTAG).'</th>
					<th>'.baseAppHelper::linkOrder(JText::_('TEXT_OPERATOR'), 'T1.operator', $APPTAG).'</th>
					<th class="text-center">'.baseAppHelper::linkOrder(JText::_('FIELD_LABEL_MAIN'), 'T1.main', $APPTAG).'</th>
