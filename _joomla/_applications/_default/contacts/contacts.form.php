			...
			<div class="col-lg-9">
				<div class="row">
					...
					<div class="col-lg-7">
						...
						<div class="accessFields collapse">
							<div class="form-group no-margin">
								<div class="input-group">
									<select name="newUser" id="<?php echo $APPTAG?>-newUser" class="form-control auto-tab" data-target=".new-user-data">
										<option value="0" data-target-display="true"><?php echo JText::_('TEXT_NEW').' '.JText::_('TEXT_USER'); ?></option>
										<?php
											foreach ($users as $obj) {
												echo '<option value="'.$obj->id.'" data-name="'.$obj->name.'" data-email="'.$obj->email.'" data-target-display="false">'.baseHelper::nameFormat($obj->name).'</option>';
											}
										?>
									</select>
					...
					<div class="col-12">
						<div class="accessFields collapse">
							<div class="row">
								<div class="col-sm-5 new-user-data" hidden>
									<div class="form-group">
								...
								<div class="col-sm-7 new-user-data" hidden>
									<div class="form-group">
								...
								<div class="col-12 edit-user-data" hidden>
									<hr class="hr-tag" />
		...
		<div class="row">
			...
			<div class="col-md-4 col-lg-3 b-left b-dashed">
				...
				<div class="form-group">
					...
					<input type="text" name="phone[]" id="<?php echo $APPTAG?>-phone3" class="form-control field-phone" />
				</div>
			</div>
		</div>
	</div>
