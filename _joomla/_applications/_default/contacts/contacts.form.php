...
<form name="form-<?php echo $APPTAG?>" id="form-<?php echo $APPTAG?>" method="post" enctype="multipart/form-data">
	...
	<div class="modal-body">
		<fieldset>
				...
				<div class="col-sm-4">
					<div class="form-group field-required">
						...
						<span class="btn-group w-full" data-toggle="buttons">
							<label class="col btn btn-default btn-active-success" onclick="<?php echo $APPTAG?>_setType(0)">
							...
							<label class="col btn btn-default btn-active-success" onclick="<?php echo $APPTAG?>_setType(1); selectRadio('input[name=gender]:radio', 0)">
			...
			<div id="contactIsUser" class="alert alert-success m-0 hide">
			...
			<div class="row">
				<div class="col-sm-3">
					...
					<div class="form-group">
						<label><?php echo JText::_('FIELD_LABEL_IMAGE'); ?></label><br />
				...
				<div class="col-sm-9">
					<div class="form-group m-0">
						<label class="iconTip hasTooltip" title="<?php echo JText::_('FIELD_LABEL_COMMENT_DESC'); ?>"><?php echo JText::_('FIELD_LABEL_COMMENT'); ?></label>
						<textarea name="comment" rows="5" id="<?php echo $APPTAG?>-comment" class="form-control"></textarea>
					</div>
				</div>
			</div>
		</fieldset>
