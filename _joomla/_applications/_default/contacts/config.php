...
$_SESSION[$APPTAG.'newUsertype'] = $usersConfig->get('new_usertype');
if(!$_SESSION[$APPTAG.'newUsertype']) $_SESSION[$APPTAG.'newUsertype'] = 2; // default 'Registrado'
...
// crud's main table
  $cfg['mainTable']         = '#__envolute_contacts';
