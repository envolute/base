<div class="modal-footer text-right">
	<div class="btn-group">
		<button name="btn-<?php echo $APPTAG?>-save" id="btn-<?php echo $APPTAG?>-save" class="base-icon-ok btn btn-success" onclick="<?php echo $APPTAG?>_save('<?php echo $cfg['saveTrigger']?>')"> <?php echo JText::_('TEXT_SAVE'); ?></button>
	...
	<button name="btn-<?php echo $APPTAG?>-cancel" id="btn-<?php echo $APPTAG?>-cancel" class="base-icon-cancel btn btn-default mr-auto" data-dismiss="modal"> <?php echo JText::_('TEXT_CLOSE'); ?></button>
</div>
