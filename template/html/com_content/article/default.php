...
echo '<script>jQuery("body").addClass("base-media-gallery")</script>';
...
<div class="item-page <?php echo $this->pageclass_sfx?>">
	...
	if ($canEdit) echo '<span class="btn btn-success btn-xs bottom-space-xs">'.JHtml::_('icon.edit', $this->item, $params).'</span>';
