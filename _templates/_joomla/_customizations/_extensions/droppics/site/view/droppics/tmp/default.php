...
$doc->addScript(JURI::base(true).'/components/com_droppics/assets/js/bootstrap.min.js' );
    ...
    <div id="main_wrapper">
        ...
        <div id="pwrapper">
            <div class="form-inline">
            	<label><strong><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_FOLDER_GALLERY'); ?>: <span style="color:#f80; margin-left:10px;">galeria /</span></strong></label> <input type="text" id="id_gallery" name="id_gallery" value="" readonly="readonly" />
            </div>
            <div id="wpreview">
                <div id="preview"></div>
            </div>
        ...
        <div id="rightcol" class="clearfix">
            <?php if(JRequest::getBool('caninsert')): ?>
                <a id="insertimage" class="btn btn-success btn-block btn-large" style="display: none;" href="" ><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_INSERT_PICTURE'); ?></a>
                <a id="insertgallery" class="btn btn-success btn-block btn-large" href=""><i class="icon-plus"></i> <?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_INSERT_GALLERY'); ?></a>
            <?php endif; ?>
            ...
            <div>
                ...
                <div class="themesblock">
                    <div class="well">
                        <h4 class="page-header"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_THEME'); ?></h4>
                        <?php
                    ...
                    <div class="clearfix">
                        <h4 class="page-header"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_PARAMETERS'); ?></h4>
                        <div id="galeryparams">
                ...
                <div class="imageblock" style="display: none;">
                    <?php if($this->canDo->get('core.delete')): ?>
                        <a id="deleteImage" href="" class="deleteImage btn btn-danger btn-block btn-large"><i class="icon-trash"></i> <?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_DELETE'); ?></a>
                    <?php endif; ?>

                    <?php echo JHtml::_('bootstrap.startTabSet', 'imageParams', array('active' => 'imageBasic'));?>

		    	<?php echo JHtml::_('bootstrap.addTab', 'imageParams', 'imageBasic', JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAMETERS')); ?>
	                    <div id="imageparameters"></div>
	                <?php echo JHtml::_('bootstrap.endTab');?>

	                <?php if(JRequest::getBool('caninsert')): ?>
	            	<?php echo JHtml::_('bootstrap.addTab', 'imageParams', 'imageContent', JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAMETERS_SINGLE_USER_LABEL')); ?>
	                    <div id="imageblock">
	                    	    <p class="alert alert-info"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAMETERS_SINGLE_USER_DESC')?></p>
	                            ...
	                            <fieldset>
	                                ...
	                                <div class="clearfix">
	                                    <h5 class="page-header"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAM_WIDTH'); ?></h5>
	                                    <div id="imgp_source" style="width:95%;">
	                                        <label class="radio">
	                                    ...
	                                    <?php if($this->canDo->get('core.edit') || $this->canDo->get('core.edit.own')): ?>
	                                    <div class="form-inline well clearfix" id="newCustomSize" style="display:none;">
	                                        <div class="control-group">
	                                         ...
	                                         <div class="control-group">
	                                            <label><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_EDIT_IMAGE_SAVE_TO_FILENAME'); ?> :</label>
	                                            <input type="text" id="customFilename" class="input-large" />
	                                        </div>
	                                ...
	                                <div class="clearfix" style="margin-bottom: 10px;">
	                                    <h5 class="page-header"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAM_POSITION'); ?></h5>
		                        ...
		                        <div class="clearfix">
	                                    <h5 class="page-header"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAM_MARGIN'); ?></h5>
		                                <div class="floating">
		                        ...
		                        <div class="clearfix">
		                                <h5 class="page-header"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAM_BORDER'); ?></h5>
		                                <div class="floating">
		                        ...
		                        <div class="clearfix">
		                                <h5 class="page-header"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAM_SHADOW'); ?></h5>
		                                <div class="floating">
	                                ...
	                                <div class="clearfix">
	                                    <h5 class="page-header"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAM_CLICK'); ?></h5>
	                                    <div class="paraminput w100">
	                                        ...
	                                        <div id="click_content_article" class="click_content_block" style="display: none;">
	                                            <input type="text" class="input-medium" style="margin-bottom:0;" id="click_content_article_id_name" value="" disabled="disabled" size="35" />
	                                        ...
	                                        <div id="click_content_menuitem" class="click_content_block" style="display:none;">
	                                        ...
	                                        <div id="click_content_custom" class="click_content_block" style="display:none;">
	                                            <input type="text" class="input-medium" style="margin-bottom:0;" id="click_content_custom_id" placeholder="http://" size="35" />
	                                        </div>
	                                    </div>
	                                    <div class="paraminput" id="imgp_click_target_wrap" style="display: none;">
	                                ...
	                                <div class="clearfix">
	                                    <label><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMAGE_PARAM_CAPTION'); ?>:</label>
