...
$cacheparams->class			= 'ModRAXO_Allmode_PRO';
...
?>
<div class="allmode-box <?php echo $tmpl_name;?>">
<?php
...
// Output template
require JModuleHelper::getLayoutPath('mod_raxo_allmode', $tmpl);
