...
<?php if ($toplist) { ?>
	<div class="main-slider-brands no-container">
		<?php
		// Slider
		...
		?>
		<ul class="allmode-slider-<?php echo $module->id; ?>">
			<?php
			// All-mode TOP Items Output
			foreach ($toplist as $item) {
			?>
				<li class="slider-brands clearfix">
					<figure class="img-fluid m-0">
						<?php if ($item->image) echo $item->image; ?>
						<?php if ($item->title) { ?>
							<figcaption class="text-center lh-1-2">
