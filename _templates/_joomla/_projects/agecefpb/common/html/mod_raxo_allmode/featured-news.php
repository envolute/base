			...
			?>
				<div class="clearfix">
					<figure class="img-fluid pos-relative">
						...
						<?php if ($item->title) { ?>
							<figcaption class="pos-absolute pos-bottom-0 w-100 bg-dark-opacity-75 text-sm py-2 px-3">
								<a class="text-white text-lg" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
							</figcaption>
						<?php } ?>
					</figure>
				</div>
			...
			foreach ($list as $item) { ?>
				...
				<li class="p-0 mb-3 clearfix">
					...
					<ul class="set-list inline bordered list-trim small text-muted mb-1">
						...
						<li class="text-live"><?php echo $item->category; ?></li>
						<?php } ?>
