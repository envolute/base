...
if(defined('_JEXEC')) :
	...
	// jQuery UI
	$doc->addStyleSheet(JURI::base().'templates/base/libs/template/jquery/jquery-ui.min.css');
	$doc->addScript(JURI::base().'templates/base/libs/template/jquery/jquery-ui.min.js');
	// load BASE Scripts
	$doc->addScript(JURI::base().'templates/base/js/forms.js');
	$doc->addScript(JURI::base().'templates/base/js/validate.js');
	// Custom CSS/JS
	$doc->addStyleSheet( 'templates/base/css/style.guide.css' );
	$doc->addScript( 'templates/base/js/guide.js' );
// APP
else :
	// jQuery UI
	echo '
	<script src="libs/template/jquery/jquery-ui.min.js" type="text/javascript"></script>
	<link rel="stylesheet" href="libs/template/jquery/jquery-ui.min.css" type="text/css" />
	';
	// load BASE Scripts
	echo '
...
<div class="row">
	<div class="col-lg-9">
		...
		<section id="color-scheme">
			...
			<div class="row mb-1">
				<div class="col-md-3"><span class="badge badge-warning">BASE</span></div>
			...
			<hr />
			<p><span class="badge badge-primary">BOOTSTRAP</span></p>
			<div class="row mb-1">
				...
				<div class="col-md-3"><div class="text-color valign-middle all-expand-lg border-radius set-border border-default">Text Color<br /><code>$body-color</code></div></div>
			...
			<hr class="hr-label" /><span class="badge badge-default">Gray</span>
			<div class="row mb-1">
			...
			<div class="row mb-1">
				<div class="col-md-3"><hr class="hr-label my-xs" /><span class="badge badge-default">Brand colors</span></div>
				<div class="col-md-3"><hr class="hr-label my-xs" /><span class="badge badge-default">Context BG</span></div>
				<div class="col-md-3"><hr class="hr-label my-xs" /><span class="badge badge-default">Context tr/td BG</span></div>
				<div class="col-md-3"><hr class="hr-label my-xs" /><span class="badge badge-default">Context Text colors</span></div>
			</div>
			<div class="row">
				<div class="col-md-3">
					<div class="btn-primary valign-middle all-expand-lg border-radius mb-1"><code>$brand-primary</code></div>
					<div class="btn-success valign-middle all-expand-lg border-radius mb-1"><code>$brand-success</code></div>
					<div class="btn-info valign-middle all-expand-lg border-radius mb-1"><code>$brand-info</code></div>
					<div class="btn-warning valign-middle all-expand-lg border-radius mb-1"><code>$brand-warning</code></div>
					<div class="btn-danger valign-middle all-expand-lg border-radius mb-1"><code>$brand-danger</code></div>
				</div>
				<div class="col-md-3">
					<div class="valign-middle all-expand-lg border-radius mb-1">&nbsp;</div>
					<div class="bg-success valign-middle all-expand-lg border-radius mb-1"><code>.bg-success</code></div>
					<div class="bg-info valign-middle all-expand-lg border-radius mb-1"><code>.bg-info</code></div>
					<div class="bg-warning valign-middle all-expand-lg border-radius mb-1"><code>.bg-warning</code></div>
					<div class="bg-danger valign-middle all-expand-lg border-radius mb-1"><code>.bg-danger</code></div>
				</div>
				<div class="col-md-3">
					<table class="table">
				...
				<div class="col-md-3">
					<div class="text-primary valign-middle all-expand-lg border-radius mb-1"><strong>Primary</strong><code class="float-right">.text-active</code></div>
					<div class="text-success valign-middle all-expand-lg border-radius mb-1"><strong>Success</strong><code class="float-right">.text-success</code></div>
					<div class="text-info valign-middle all-expand-lg border-radius mb-1"><strong>Info</strong><code class="float-right">.text-info</code></div>
					<div class="text-warning valign-middle all-expand-lg border-radius mb-1"><strong>Warning</strong><code class="float-right">.text-warning</code></div>
					<div class="text-danger valign-middle all-expand-lg border-radius mb-1"><strong>Danger</strong><code class="float-right">.text-danger</code></div>
				</div>
			</div>
		...
		<section id="fonts">
			...
			<h1 class="page-header mb-0">Fonts <span class="badge badge-warning text-md float-right mt-1">BASE</span></h1>
		...
		<section id="navbar">
			...
			<h1 class="page-header">Navbar <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
		...
		<section id="buttons">
			...
			<h1 class="page-header">Buttons <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
			...
			<div id="dropdown-hover" class="well mt-1">
				<div class="row">
					<div class="col-lg-6">
...
&lt;/div&gt;
		...
		<section id="type">
			...
			<h1 class="page-header">Typography <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
			...
			<div class="well">
				<h4 class="page-header">Additional Options for Text Format <span class="badge badge-warning float-right">BASE</span></h4>
				<div class="row">
					<div class="col-lg-3">
					...
					<div class="bs-component">
						...
						<span class="badge badge-info"><span class="base-icon-info-circled"></span> Emphasis Color</span>
					</div>
					</div>
					<div class="col-lg-3">
					<div class="bs-component">
					...
					<div class="bs-component">
						...
						<span class="badge badge-info"><span class="base-icon-info-circled"></span> Text limited by container</span>
					</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-6">
					<div class="bs-component">
						<p><span class="badge badge-primary">FIXED FONT SIZE</span></p>
						...
						<code>&lt;p class="text-md" /&gt;</code> <span class="badge badge-default">Default</span>
					...
					<div class="col-lg-6">
					<div class="bs-component">
						<p><span class="badge badge-primary">CONTEXTUAL FONT SIZE</span> <span class="badge badge-info">Note: recommended for "Font-Sizer"</span></p>
			...
			<div class="row">
				<div class="col-lg-3">
				<p><span class="badge badge-primary">Left</span> <code>&lt;p class="text-left" /&gt;</code></p>
				...
				<div class="col-lg-3">
				<p><span class="badge badge-primary">Right</span> <code>&lt;p class="text-right" /&gt;</code></p>
				...
				<div class="col-lg-3">
				<p><span class="badge badge-primary">Center</span> <code>&lt;p class="text-center" /&gt;</code></p>
				...
				<div class="col-lg-3">
				<p><span class="badge badge-primary">Justify</span> <code>&lt;p class="text-justify" /&gt;</code></p>
			...
			<div class="well">
				<h4 class="page-header">Responsive Alignment <span class="badge badge-warning float-right">BASE</span></h4>
				<table class="table">
					<thead>
						<tr>
				...
				<div class="row">
					<div class="col-lg-4">
					<div class="bs-component">
						<p><span class="badge badge-primary">Left</span> <code>&lt;img class="obj-to-left" /&gt;</code></p>
						<p>
					...
					<div class="col-lg-4">
					<div class="bs-component">
						<p><span class="badge badge-primary">Center</span> <code>&lt;img class="obj-to-center" /&gt;</code></p>
						<p>
					...
					<div class="col-lg-4">
					<div class="bs-component">
						<p><span class="badge badge-primary">Right</span> <code>&lt;img class="obj-to-right" /&gt;</code></p>
						<p>
			...
			<div class="well">
				<h4 class="page-header">Additional Spacing Options for horizontal rule <span class="badge badge-warning float-right">BASE</span></h4>
				<div class="row">
					<div class="col-lg-4">
					<div class="bs-component">
						<span class="badge badge-primary">Extra Small</span> <code>&lt;hr class="my-xs" /&gt;</code>
						<div class="bg-gray"><hr class="my-xs" /></div>
					</div>
					</div>
					<div class="col-lg-4">
					<div class="bs-component">
						<span class="badge badge-primary">Small</span> <code>&lt;hr class="my-sm" /&gt;</code>
						<div class="bg-gray"><hr class="my-sm" /></div>
					</div>
					</div>
					<div class="col-lg-4">
					<div class="bs-component">
						<span class="badge badge-primary">Large</span> <code>&lt;hr class="my-lg" /&gt;</code>
						<div class="bg-gray"><hr class="my-lg" /></div>
					</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-4">
					<div class="bs-component">
						<span class="badge badge-primary">Strong</span> <code>&lt;hr class="hr-strong" /&gt;</code>
						<div class="bg-gray"><hr class="hr-strong" /></div>
					</div>
					</div>
					<div class="col-lg-4">
					<div class="bs-component">
						<span class="badge badge-primary">White</span> <code>&lt;hr class="hr-white" /&gt;</code>
						<div class="bg-gray"><hr class="hr-white" /></div>
					</div>
					</div>
					<div class="col-lg-4">
					<div class="bs-component">
						<span class="badge badge-primary">Live</span> <code>&lt;hr class="hr-live" /&gt;</code>
				...
				<div class="row">
					...
					<div class="col-lg-6">
					<div class="bs-component">
						<hr class="hr-label" /><span class="label float-right">right</span>
						<p><code>&lt;hr class="hr-label" /&gt;&lt;span class="label float-right"&gt;right&lt;/span&gt;&lt;/code&gt;</code></p>
					</div>
					</div>
				</div>
				<div class="alert alert-info">
					<span class="base-icon-info-circled"></span> To align the label right just add the class <em class="strong">.float-right</em> to label
					<br /><span class="base-icon-info-circled"></span> The &lt;hr /&gt; tag can be used with classes <em class="strong">my-xs, .my-sm & my-lg</em>
			...
			<div>
				...
				<code class="float-right">&lt;blockquote class="blockquote-reverse" /&gt;</code>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<blockquote>
			...
			<div class="row">
				<div class="col-lg-4">
					<p><span class="badge badge-primary">Unordered</span> <code>&lt;ul&gt;</code></p>
					<ul>
				...
				<div class="col-lg-4">
					<p><span class="badge badge-primary">Ordered</span> <code>&lt;ol&gt;</code></p>
					<ol>
						<li>Lorem ipsum dolor sit amet</li>
						<li>Nulla volutpat aliquam velit
						<ol>
				...
				<div class="col-lg-4">
					<p><span class="badge badge-primary">Unstyled</span> <code>&lt;ul class="list-unstyled" /&gt;</code></p>
			...
			<hr />
			<div class="mb-1">
				<p><span class="badge badge-primary">Inline</span> <code>&lt;ul class="list-inline" /&gt;</code></p>
			...
			<div class="row">
				<div class="col-lg-6">
					<p><span class="badge badge-primary">DESCRIPTION</span> <code>&lt;dl&gt;</code></p>
					<dl>
				...
				<div class="col-lg-6">
					<p><span class="badge badge-primary">DESCRIPTION HORIZONTAL</span> <code>&lt;dl class="dl-horizontal" /&gt;</code></p>
			...
			<div class="well">
				<h4 class="page-header">Additional Options for Lists <span class="badge badge-warning float-right">BASE</span></h4>
				<div class="row">
					<div class="col-lg-3">
						<span class="badge badge-primary">LIST</span>
					...
					<div class="col-lg-3">
						<span class="badge badge-default">SMALL</span>
					...
					<div class="col-lg-3">
						<span class="badge badge-default">LARGE</span>
					...
					<div class="col-lg-3">
						<span class="badge badge-default">STRIPED</span>
				...
				<div class="row">
					<div class="col-lg-3">
						<span class="badge badge-primary">LIST MENU</span>
				...
				<div class="row">
					<div class="col-lg-6">
					<div class="pb-1">
						<p><span class="badge badge-primary">HLIST</span> <code>&lt;ul class="hlist" /&gt;</code></p>
						<ul class="hlist">
							<li>Item 1</li>
							<li>Item 2</li>
							<li>Item 3</li>
					...
					<div class="pb-1">
						<p><span class="badge badge-default">SMALL</span> <code>&lt;ul class="hlist hlist-sm" /&gt;</code></p>
					...
					<div class="pb-1">
						<p><span class="badge badge-default">LARGE</span> <code>&lt;ul class="hlist hlist-lg" /&gt;</code></p>
					...
					<div class="pb-1">
						<p><span class="badge badge-default">STRIPED</span> <code>&lt;ul class="hlist list-striped" /&gt;</code></p>
					...
					<div class="col-lg-6">
					<div class="pb-1">
						<p><span class="badge badge-primary">HLIST MENU</span> <code>&lt;ul class="hlist-menu" /&gt;</code></p>
						<ul class="hlist-menu">
					...
					<div class="pb-1">
						<p><span class="badge badge-default">SMALL</span> <code>&lt;ul class="hlist-menu hlist-sm" /&gt;</code></p>
					...
					<div class="pb-1">
						<p><span class="badge badge-default">LARGE</span> <code>&lt;ul class="hlist-menu hlist-lg" /&gt;</code></p>
					...
					<div class="pb-1">
						<p><span class="badge badge-default">STRIPED</span> <code>&lt;ul class="hlist-menu list-striped" /&gt;</code></p>
		...
		<section id="tables">
			...
			<h1 class="page-header">Tables <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
		...
		<section id="forms">
			...
			<h1 class="page-header">Forms <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>

			<div class="row">
				<div class="col-lg-4">
					<form>
					<div class="pb-1"><span class="badge badge-primary">FORM DEFAULT</span> <code>&lt;form&gt;</code></div>
					<fieldset>
						<legend>Legend <span class="badge badge-default float-right">Fieldset</span></legend>
						<div class="form-group">
				...
				<div class="col-lg-7 col-lg-offset-1">
					...
					<div class="pb-1"><span class="badge badge-primary">FORM HORIZONTAL</span> <code>&lt;form class="form-horizontal" /&gt;</code></div>
					<fieldset>
						<legend>Legend <span class="badge badge-default float-right">Fieldset</span></legend>
						<div class="form-group">
					...
					<div class="pb-1"><span class="badge badge-primary">FORM INLINE</span> <code>&lt;form class="form-inline" /&gt;</code></div>
						<div class="form-group">
			...
			<div class="row">
				<div class="col-lg-3">
					...
					<div class="form-group">
						...
						<input class="form-control form-control-sm" type="text" name="name" id="inputSmall" placehoder=".form-control-sm" />
					</div>
					<div class="form-group">
						<label class="control-label" for="inputLarge">Large input</label>
						<input class="form-control form-control-lg" type="text" name="name" id="inputLarge" placehoder=".form-control-lg" />
					</div>
					</form>
				</div>
				<div class="col-lg-3">
			...
			<div class="well">
				<h4 id="form-base" class="page-header"><span class="base-icon-star text-live"></span> Additional Options for Forms <span class="badge badge-warning float-right">BASE</span></h4>
				<div class="row">
					<div class="col-lg-6">
						...
						<fieldset class="fieldset-bordered">
							...
							<code class="float-right">&lt;div class="form-actions" /&gt;</code>
					...
					<div class="col-lg-6 mt-1">
						...
						<div class="alert alert-info"><p><span class="base-icon-info-circled"></span> To alignment options, use this class together with the alignment classes <span class="badge badge-default">.text-right</span> <span class="badge badge-default">.text.center</span></p>This container also works well with Tabs ... see a sample tab in the <a href="#goto-custom-fields">custom fields</a></div>
					</div>
				</div>
				<h4 class="page-header mt-1">Fieldset Embed <small>(It is a fieldset option to toggle button)</small></h4>
				<p>
					<button name="name" class="btn btn-primary" onclick="toggleFieldsetEmbed(this, '#fe-1', 100)">Show/Hide Fieldset</button>
					<span class="badge badge-primary text-md float-right">Legend right option</span>
				</p>
				<div class="row">
					<div class="col-lg-6">
					...
					<div class="col-lg-6">
						<fieldset class="fieldset-embed pt-2">
							<legend class="float-right"><span class="base-icon-filter"></span> Filter</legend>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group field-required">
										<label>Label</label><br />
				...
				<div class="row mt-1">
					<div class="col-lg-6">
<pre class="mt-1">&lt;fieldset <strong class="text-danger">class="fieldset-embed"</strong> /&gt;
&lt;legend&gt;&lt;span class="base-icon-filter"&gt;&lt;/span&gt; Filter&lt;/legend&gt;
...
...
&lt;/fieldset&gt;
					...
					<div class="col-lg-6 mt-1">
<pre>&lt;fieldset class="fieldset-embed <strong class="text-danger">pt-2</strong>" /&gt;
&lt;legend <strong class="text-danger">class="float-right"</strong>&gt; ... &lt;/legend&gt;
...
...
&lt;/fieldset&gt;
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<fieldset id="flt-1" class="fieldset-embed closed" data-group="fe-sample" data-toggle-element=".single-filter">
							<legend>Fieldset 1</legend>
							<code>&lt;fieldset <em class="strong text-danger">data-group="fe-sample"  data-toggle-element=".single-filter"</em> class="fieldset-embed closed" id="flt-1"&gt;</code>
						</fieldset>
						...
						<div class="well well-sm single-filter">
							This area will be alternated with Fieldset 1. Simply assign the class or element ID on the property "data-toggle-element" of the fieldset
							<code>&lt;div <em class="strong text-danger">class="single-filter"</em>&gt;...&lt;div&gt;</code>
						</div>
					</div>
				</div>
				<hr />
				<h4 class="page-header mt-1">Form Indicators</h4>
				<div class="row">
					<div class="col-lg-6">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group field-required">
							<p>
								<label class="iconTip hasTooltip" data-animation="false" title="This is Tooltip in label">Tooltip Label</label>
								<br><code>&lt;label class="iconTip hasTooltip" data-animation="false" title="..."&gt;</code><br />
							</p>
							<p>
						...
						<hr />
						<div class="form-group field-required">
							<label>Tip for Indicator</label> <span class="iconTip hasTooltip" data-animation="false" title="This is indicator tooltip"></span> <span class="iconTip hasPopover" title="This is indicator Popover" data-content="This is Popover content"></span>
							<p><code>&lt;span class="iconTip hasTooltip" data-animation="false" title="..."&gt;&lt;span&gt;</code><br /><code>&lt;span class="iconTip hasPopover" title="..."&gt;&lt;span&gt;</code></p>
							<input type="text" name="name" class="" /> <span class="iconTip hasTooltip" data-animation="false" title="This is indicator tooltip"></span> <span class="iconTip hasPopover" title="This is indicator Popover" data-content="This is Popover content"></span>
						</div>
					</div>
					<div class="col-lg-6">
						...
						<div class="form-group">
							<p>
								<code>&lt;input class="hasTooltip" data-animation="false" title="..." data-content="..."&gt;</code>
								<input type="text" name="name" class="form-control hasTooltip" data-animation="false" title="Title for Tooltip" placeholder="Set hover or focus here" />
							</p>
							<p>
				...
				<div class="well well-sm">
					<h4 class="page-header m-0"><span class="base-icon-comment-square mr-1"></span> Custom Classes to Set Tooltips & Popovers</h4>
				...
				<h4 class="page-header mt-1">INPUT FILE <small>(This is an option for fields of type 'file')</small></h4>
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group field-required">
							<label>Label</label>
							<div class="input-group">
								...
								<span class="input-group-btn">
									<button type="button" class="base-icon-download btn btn-default file-action"></button>
								</span>
							</div>
						</div>
						<p>Just assign a field of type "file" in a "input-group" with a button (input-group-btn). To implement the action on the button just assign it the class "<em class="strong text-danger">file-action</em>".</p>
					</div>
					<div class="col-lg-6">
...
&lt;/div&gt;
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="masks">
						<div class="row">
							<div class="col-lg-6">
								...
								<p><span class="badge badge-default">Special Masks</span></p>
								...
								<div class="alert alert-warning strong mt-1">
							...
							<div class="row">
								<div class="col-md-7">
									<form onsubmit="dateConvert(); priceDecimal(); return false;">
										<div class="pb-1"><span class="badge badge-primary">TEST DATA-CONVERT</span></div>
										  <div class="form-group">
											<label for="test-date" class="clear">Date</label>
											<input type="text" id="test-date" name="date_converted" class="form-control field-date float-left mr-1" data-autotab="false" data-width="8.5em" data-convert="true" />
						...
						<h4 class="page-header pt-2">Form Actions</h4>
						<div class="form-actions">
							<code class="float-right">&lt;div class="form-actions" /&gt;</code>
							<button type="reset" name="name" class="btn btn-default">Cancel</button>
							<button type="submit" name="name" class="btn btn-primary">Submit</button>
							<span class="badge badge-primary">INSIDE TAB-PANE</span>
						</div>
					</div>
					<div role="tabpanel" class="tab-pane" id="group">
						<div class="row">
							<div class="col-lg-4">
								...
								<div class="form-group">
									...
									<div class="btn-group" data-toggle="buttons">
										<label class="btn btn-default btn-active-primary">
											<input type="checkbox" name="field" class="auto-tab" data-target="check1" data-target-display="true"> Check 1
										</label>
								...
								<div class="form-group">
									<p><input type="text" name="field" id="check1" class="form-control" hidden placeholder="Primary" /></p>
									<p><input type="text" name="field" id="check2" class="form-control" hidden placeholder="Info" /></p>
									<p><input type="text" name="field" id="check3" class="form-control" hidden placeholder="Warning" /></p>
									<p><input type="text" name="field" id="check4" class="form-control" hidden placeholder="Danger" /></p>
								</div>
							</div>
							<div class="col-lg-4">
								...
								<div class="row">
									<div class="col-md-6 width-auto">
										<div class="form-group">
											<label>Btn group</label><br />
											<div class="btn-group" data-toggle="buttons">
												<label class="btn btn-default active btn-active-danger">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" id="radio-target-3" name="radio-target-3" class="form-control" hidden />
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-4">
								...
								<div class="form-group">
									<label>Target</label>
									<span class="base-icon-down text-danger float-right"></span>
						...
						<div class="alert alert-warning strong mt-1"><span class="base-icon-attention-alt-inv"></span> To enable/disable, show/hide or assign a value through &lt;select&gt;element, the attributes should be added to the &lt;option&gt; element</div>
					</div>
							...
							<div class="col-md-6">
								<form id="form-validator">
									<fieldset class="fieldset-bordered">
										...
										<div class="alert alert-success" hidden><span class="base-icon-ok"></span> Success!</div>
...
&lt;/div&gt;
					...
					<div role="tabpanel" class="tab-pane" id="restrictions">
						<div class="row">
							<div class="col-lg-6">
								...
								<span class="badge badge-default float-right">together</span>
							...
							<div class="col-lg-6">
								...
								<span class="badge badge-default float-right">{}[]&ordf;&ordm;/\;:.,<>!@#$%&*()_-+=?"'|...</span>
								...
								<span class="badge badge-default float-right">&aacute;&eacute;&iacute;&oacute;&uacute;&Aacute;&Eacute;&Iacute;&Oacute;&Uacute;&acirc;&ecirc;&icirc;&ocirc;&ucirc;&Acirc;&Ecirc;&Icirc;&Ocirc;&Ucirc;&atilde;&otilde;&Atilde;&Otilde;&agrave;&Agrave;&ccedil;&Ccedil;&acute;&#94;&#96;&#126;</span>
								...
								<label><span class="badge badge-primary">Together:</span> <span class="badge badge-default">field-nonumber</span> <span class="badge badge-default">no-special-character</span> <span class="badge badge-default">no-accents</span> <span class="badge badge-default">no-blank-space</span></label>
				...
				<div class="form-actions">
					...
					<button type="reset" name="name" class="btn btn-default">Cancel</button>
					<button type="submit" name="name" class="btn btn-primary">Submit</button>
					<span class="badge badge-primary">AFTER TAB-CONTENT</span>
				</div>
			</div>
		</section>
		...
		<section id="nav">
			...
			<h1 class="page-header">Navs <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
			...
			<div class="well mt-1">
				<h4 id="nav-menu" class="page-header">
					<span class="base-icon-star text-live"></span> Nav Pill Menu <small>Horizontal Menu Option</small> <span class="badge badge-warning float-right">BASE</span>
				</h4>
				<div class="row">
					<div class="col-lg-8">
					...
					<div class="col-lg-4">
<pre class="m-0">&lt;ul class="nav nav-pills <em class="strong text-danger">menu</em>"&gt;
&lt;li&gt;...&lt;/li&gt;
&lt;li&gt;
&lt;a&gt;...&lt;/a&gt;
...
&lt;/ul&gt;
				...
				<div class="row">
					...
					<div class="col-lg-4">
						...
						<span class="badge badge-primary">Bordered Option</span>
					</div>
					<div class="col-lg-4">
<pre class="m-0">&lt;ul class="nav <em class="strong text-danger">list-menu</em>"&gt;
&lt;li&gt;...&lt;/li&gt;
&lt;li&gt;
&lt;a&gt;...&lt;/a&gt;
...
&nbsp;
<pre class="m-0">&lt;ul class="nav <em class="strong text-danger">list-menu set-border border-default</em>"&gt;
&lt;li&gt;...&lt;/li&gt;
&lt;li&gt;
&lt;a&gt;...&lt;/a&gt;
&lt;ul <em class="strong text-danger">class="nav-child"</em>&gt;
...
&lt;/ul&gt;
			...
			<div class="row">
				...
				<div class="col-lg-6">
				<div class="well well-sm">
					<h4 class="page-header pt-2"><span class="base-icon-star text-live"></span> Collapse Indicator <span class="badge badge-warning float-right">BASE</span></h4>
					<p>
			...
			<div id="nav-steps" class="well">
				<h3 class="page-header mt-0"><span class="base-icon-star text-live"></span> Steps <span class="badge badge-warning text-sm float-right">BASE</span></h3>
				<div class="row">
					<div class="col-lg-6">
...
<pre class="m-0">&lt;ul class="nav-wizard"&gt;
&lt;li&gt;
...
&lt;/ul&gt;
		...
		<section id="images">
			...
			<h1 class="page-header">Images <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
		...
		<section id="indicators">
			...
			<h1 class="page-header">Indicators <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
			...
			<div class="well">
				<h4 id="alerts-context-icons" class="page-header"><span class="base-icon-star text-live"></span> Alerts Context Icons<span class="badge badge-warning float-right">BASE</span><span class="badge badge-primary float-right mr-1">BOOTSTRAP</span></h2>
				<div class="row">
					<div class="col-lg-6">
				...
				<div class="row">
					<div class="col-lg-6">
						<div>
							<span class="badge badge-default">Help</span>
							<code class="float-right">... alert-icon <em class="strong">help</em>"</code>
						</div>
					...
					<div class="col-lg-6">
						<div>
							<span class="badge badge-default">Note, Tips</span>
							<code class="float-right">... alert-icon <em class="strong">note</em>"</code>
						</div>
...
&lt;/div&gt;
		...
		<section>
			...
			<h1 id="progress" class="page-header">Progress bars <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
			...
			<div class="well">
				<h4 id="load-activity" class="page-header"><span class="base-icon-star text-live"></span> Load Activity<span class="badge badge-warning float-right">BASE</span><span class="badge badge-primary float-right mr-1">BOOTSTRAP</span></h4>
				<div class="row">
					<div class="col-lg-6">
						...
						<script>
							function loaderFull(full) {
								toggleLoader('#loader', full);
								setTimeout(function() { toggleLoader('#loader', full) }, 5000);
							}
						</script>
						<div id="loader" class="progress progress-striped">
							<img src="<?php echo $base?>images/core/loader-active.gif">
							<div class="progress-bar progress-bar-success"></div>
						</div>
<pre>&lt;div id="loader" class="progress progress-striped"&gt;
&lt;img src="images/core/loader-active.gif"&gt;
&lt;div class="progress-bar progress-bar-success"&gt;&lt;/div&gt;
&lt;/div&gt;
</pre>
					</div>
					<div class="col-lg-6">
						<p>After defining the element in html. Just call the function <strong>toggleLoader(element, (Bool) fullscreen)</strong> both to show how to hide the loader.</p>
						...
						<p>2 - Assign "true" to parameter in the function "toggleLoader". Eg <code>toggleLoader('#loader', true);</code>
						<p class="alert alert-info alert-icon">
							If the class "fullScreen" is assigned to the object, we can load the loader in the initial format, giving "false" parameter to the function.<br />Eg <code>toggleLoader('#loader', false);</code>.
		...
		<section id="list-groups">
			...
			<h1 class="page-header">List groups <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
		...
		<section id="panels">
			...
			<h1 class="page-header">Panels <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
		...
		<section id="well">
			...
			<h1 class="page-header">Wells <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
		...
		<section id="dialogs">
			...
			<h1 class="page-header">Dialogs <span class="badge badge-primary text-md float-right mt-1">BOOTSTRAP</span></h1>
		...
		<section id="module">
			...
			<h1 class="page-header">
				<span class="base-icon-star text-live"></span> Module <span class="badge badge-warning text-md float-right mt-1">BASE</span>
			</h1>
...
&lt;/div&gt;
			...
			<div class="row">
				...
				<div  class="module text-xs clearfix">
					<h3 class="page-header clearfix ">
						<span class="head-container">Header</span>
						<span class="head-tag"><span class="badge badge-warning text-xs">Extra Small</span></span>
					</h3>
					<div class="module-body">
						<div class="module-content">
							Nullam quis risus eget vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nullam id dolor id nibh ultricies vehicula...
				...
				<div  class="module text-sm clearfix">
					<h3 class="page-header clearfix ">
						<span class="head-container">Header</span>
						<span class="head-tag"><span class="badge badge-warning text-xs">Small</span></span>
					</h3>
					<div class="module-body">
						<div class="module-content">
							Nullam quis risus eget vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nullam id dolor id nibh ultricies vehicula...
				...
				<div  class="module text-lg clearfix">
					<h3 class="page-header clearfix ">
						<span class="head-container">Header</span>
						<span class="head-tag"><span class="badge badge-warning text-xs">Large</span></span>
					</h3>
					<div class="module-body">
						<div class="module-content">
							Nullam quis risus eget vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nullam id dolor id nibh ultricies vehicula...
		...
		<section id="base-helper">
			...
			<h1 class="page-header">
				<span class="base-icon-star text-live"></span> Helper Classes from Base <span class="badge badge-warning text-md float-right mt-1">BASE</span>
			</h1>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						<td>.hidden-logged <span class="badge badge-warning float-right">JOOMLA</span></td>
						<td>Hides the element when the user is logged in</td>
					</tr>
					<tr>
						<td>.hidden-public <span class="badge badge-warning float-right">JOOMLA</span></td>
					...
					<tr>
						<td>.view-state.view</td>
						<td>Displayed element</td>
					</tr>
					<tr>
						<td>.view-state.on-screen</td>
					...
					<tr>
						<td>.float-none</td>
						<td>Alias to ".no-float" class. <em>Complements the classes float-[left|right] bootstrap</em></td>
					</tr>
					<tr>
					...
					<tr>
						<th colspan="2" class="active">SPACING <span class="badge badge-warning">MARGIN</span></th>
					</tr>
					<tr>
						<td>.all-space</td>
					...
					<tr>
						<td>-xs</td>
						<td>Set spacing to <strong>5px</strong>. Eg: <em class="strong text-danger">mt-xs</em> assigns the margin of <em class="strong text-danger">5px</em> above the element</td>
					</tr>
					<tr>
						<td>-sm</td>
						<td>Set spacing to <strong>10px</strong>. Eg: <em class="strong text-danger">mt-sm</em> assigns the margin of <em class="strong text-danger">10px</em> above the element</td>
					</tr>
					<tr>
						<th colspan="2" class="warning"><span class="base-icon-block text-danger"></span> Remove Spacing <span class="badge badge-warning">MARGIN</span></th>
					</tr>
					<tr>
						<td>.m-0</td>
					...
					<tr>
						<th colspan="2" class="active">EXPAND <span class="badge badge-warning">PADDING</span></th>
					</tr>
					<tr>
						<td>.all-expand</td>
					...
					<tr>
						<td>-xs</td>
						<td>Set expand to <strong>5px</strong>. Eg: <em class="strong text-danger">pt-sm</em> assigns the padding of <em class="strong text-danger">5px</em> above the element</td>
					</tr>
					<tr>
						<td>-sm</td>
						<td>Set expand to <strong>20px</strong>. Eg: <em class="strong text-danger">pt-2</em> assigns the padding of <em class="strong text-danger">20px</em> above the element</td>
					</tr>
					<tr>
						<th colspan="2" class="warning"><span class="base-icon-block text-danger"></span> Remove Expand <span class="badge badge-warning">PADDING</span></th>
					</tr>
					<tr>
						<td>.no-padding</td>
					...
					<tr>
						<th colspan="2" class="active">PAGE BREAK <span class="badge badge-warning">ONLY IN PRINT</span></th>
					</tr>
					<tr>
						<td>.page-break</td>
