	...
	<?php endif; ?>
		...
		<div class="form-actions mt-1">
			<button type="submit" class="btn btn-success validate">
				<span class="base-icon-ok btn-icon"></span> <?php echo JText::_('JSAVE'); ?>
			</button>
			<a class="base-icon-cancel btn btn-default" href="<?php echo JRoute::_(''); ?>" title="<?php echo JText::_('JCANCEL'); ?>"> <?php echo JText::_('JCANCEL'); ?></a>
