	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset>
			...
			<div class="form-group row">
				<div class="col-md-3 text-right"><?php echo $this->form->getLabel('contact_name'); ?></div>
				<div class="col-md-9"><?php echo $this->form->getInput('contact_name',null,$name); ?></div>
			</div>
			<div class="form-group row">
				<div class="col-md-3 text-right"><?php echo $this->form->getLabel('contact_email'); ?></div>
				<div class="col-md-9"><?php echo $this->form->getInput('contact_email',null,$email); ?></div>
			</div>
			<div class="form-group row">
				<div class="col-md-3 text-right"><?php echo $this->form->getLabel('contact_subject'); ?></div>
				<div class="col-md-9"><?php echo $this->form->getInput('contact_subject',null,$subj); ?></div>
			</div>
			<div class="form-group row">
				<div class="col-md-3 text-right"><?php echo $this->form->getLabel('contact_message'); ?></div>
				<div class="col-md-9"><?php echo $this->form->getInput('contact_message',null,$msg); ?>
					...
					<?php foreach($fields as $field): ?>
							...
							<?php else:?>
								<div class="form-group row">
									...
									<div class="col-md-9"><?php echo $field->input;?></div>
								</div>
							<?php endif;?>
					<?php endforeach;?>
				<?php endif ?>
